...
app.get('/api', (req, res) => {
  res.json({ mensagem: 'Zentry API rodando' })
})
...
app.use('/contatos', authMiddleware, contatosRoutes)
app.use('/vendedores', authMiddleware, vendedoresRoutes)
app.use('/embalagens', authMiddleware, embalagensRoutes)
