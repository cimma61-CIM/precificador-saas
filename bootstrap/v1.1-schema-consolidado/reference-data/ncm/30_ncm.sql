...
INSERT INTO public.ncm (codigo, descricao) VALUES
  ...
  ('0105.94.00', '-- Aves da espécie <i>Gallus domesticus</i>'),
  ('0105.99.00', '-- Outros'),
  ('0106.11.00', '-- Primatas'),
  ...
  ('0106.13.00', '-- Camelos e outros camelídeos (<i>Camelidae</i>)'),
  ...
  ('0106.33.10', 'Avestruzes (<i>Struthio camelus</i>), para reprodução'),
  ('0106.33.90', 'Outros'),
  ('0106.39.00', '-- Outras'),
  ('0106.41.00', '-- Abelhas'),
  ('0106.49.00', '-- Outros'),
  ...
  ('0207.43.00', '-- Fígados gordos (<i>foies gras</i>), frescos ou refrigerados'),
  ...
  ('0207.53.00', '-- Fígados gordos (<i>foies gras</i>), frescos ou refrigerados'),
  ...
  ('0208.60.00', '- De camelos e outros camelídeos (<i>Camelidae</i>)'),
  ('0208.90.00', '- Outras'),
  ...
  ('0301.95.90', 'Outros'),
  ('0301.99.11', 'Tilápias (<i>Tilapia</i> spp.<i>, Oreochromis</i> spp.<i>, Sarotherodon</i> spp.<i>, Danakilia</i> spp.; seus híbridos)'),
  ('0301.99.12', 'Esturjões (<i>Acipenser baerii, Acipenser gueldenstaedtii, Acipenser persicus, Acipenser stellatus</i>)'),
  ('0301.99.19', 'Outros'),
  ('0301.99.91', 'Tilápias (<i>Tilapia</i> spp.<i>, Oreochromis</i> spp.<i>, Sarotherodon</i> spp.<i>, Danakilia</i> spp.; seus híbridos)'),
  ('0301.99.92', 'Esturjões (<i>Acipenser baerii, Acipenser gueldenstaedtii, Acipenser persicus, Acipenser stellatus</i>)'),
  ('0301.99.99', 'Outros'),
  ...
  ('0302.13.00', '-- Salmões-do-pacífico (<i>Oncorhynchus nerka, Oncorhynchus gorbuscha, Oncorhynchus keta, Oncorhynchus tschawytscha, Oncorhynchus kisutch, Oncorhynchus masou</i> e <i>Oncorhynchus rhodurus</i>)'),
  ('0302.14.00', '-- Salmão-do-atlântico (<i>Salmo salar</i>) e salmão-do-danúbio (<i>Hucho hucho</i>)'),
  ('0302.19.00', '-- Outros'),
  ...
  ('0302.46.00', '-- Bijupirá (Cobia*) (<i>Rachycentron canadum</i>)'),
  ('0302.47.00', '-- Espadarte (<i>Xiphias gladius</i>)'),
  ('0302.49.10', 'Espadins, marlins, veleiros (<i>Istiophoridae</i>)'),
  ('0302.49.90', 'Outros'),
  ('0302.51.00', '-- Bacalhau-do-atlântico (<i>Gadus morhua</i>), bacalhau-da-groelândia (<i>Gadus ogac</i>) e bacalhau-do-pacífico (<i>Gadus macrocephalus</i>)'),
  ('0302.52.00', '-- Hadoque (Arinca*) (<i>Melanogrammus aeglefinus</i>)'),
  ('0302.53.00', '-- Saithe (Escamudo*) (<i>Pollachius virens</i>)'),
  ('0302.54.00', '-- Merluzas (Pescadas*) e abróteas (<i>Merluccius</i> spp.<i>, Urophycis</i> spp.)'),
  ...
  ('0302.59.00', '-- Outros'),
  ('0302.71.00', '-- Tilápias (<i>Oreochromis</i> spp.)'),
  ...
  ('0302.83.20', 'Merluza antártica (<i>Dissostichus mawsoni</i>)'),
  ('0302.84.00', '-- Robalos (<i>Dicentrarchus</i> spp.)'),
  ('0302.85.00', '-- Esparídeos (<i>Sparidae</i>)'),
  ...
  ('0302.89.23', 'Esturjão (<i>Acipenser baerii</i>)'),
  ('0302.89.24', 'Peixes-rei (<i>Atherina</i> spp.)'),
  ('0302.89.31', 'Curimatãs (<i>Prochilodus</i> spp.)'),
  ('0302.89.32', 'Tilápias (<i>Tilapia</i> spp.<i>, Sarotherodon</i> spp.<i>, Danakilia</i> spp.; seus híbridos)'),
  ('0302.89.33', 'Surubins (<i>Pseudoplatystoma</i> spp.)'),
  ('0302.89.34', 'Traíra (<i>Hoplias malabaricus & H. cf. lacerdae</i>)'),
  ...
  ('0302.99.00', '-- Outros'),
  ('0303.11.00', '-- Salmão-do-pacífico (salmão-vermelho) (<i>Oncorhynchus nerka</i>)'),
  ('0303.12.00', '-- Outros salmões-do-pacífico (<i>Oncorhynchus gorbuscha, Oncorhynchus keta, Oncorhynchus tschawytscha, Oncorhynchus kisutch, Oncorhynchus masou</i> e <i>Oncorhynchus rhodurus</i>)'),
  ('0303.13.00', '-- Salmão-do-atlântico (<i>Salmo salar</i>) e salmão-do-danúbio (<i>Hucho hucho</i>)'),
  ...
  ('0303.19.00', '-- Outros'),
  ('0303.23.00', '-- Tilápias (<i>Oreochromis</i> spp.)'),
...
INSERT INTO public.ncm (codigo, descricao) VALUES
  ...
  ('0303.56.00', '-- Bijupirá (Cobia*) (<i>Rachycentron canadum</i>)'),
  ...
  ('0303.59.90', 'Outros'),
  ('0303.63.00', '-- Bacalhau-do-atlântico (<i>Gadus morhua</i>), bacalhau-da-groelândia (<i>Gadus ogac</i>) e bacalhau-do-pacífico (<i>Gadus macrocephalus</i>)'),
  ('0303.64.00', '-- Hadoque (Arinca*) (<i>Melanogrammus aeglefinus</i>)'),
  ('0303.65.00', '-- Saithe (Escamudo*) (<i>Pollachius virens</i>)'),
  ('0303.66.00', '-- Merluzas (Pescadas*) e abróteas (<i>Merluccius</i> spp., <i>Urophycis</i> spp.)'),
  ...
  ('0303.69.90', 'Outros'),
  ('0303.81.11', 'Inteiro'),
  ('0303.81.12', 'Eviscerado, sem cabeça e sem barbatanas'),
  ('0303.81.13', 'Em pedaços, com pele'),
  ('0303.81.14', 'Em pedaços, sem pele'),
  ('0303.81.19', 'Outros'),
  ('0303.81.90', 'Outros'),
  ('0303.82.00', '-- Raias (<i>Rajidae</i>)'),
  ('0303.83.11', 'Evisceradas, sem cabeça e sem cauda'),
  ('0303.83.19', 'Outras'),
  ...
  ('0303.89.44', 'Esturjões (<i>Acipenser baerii, Acipenser gueldenstaedtii, Acipenser persicus, Acipenser stellatus</i>)'),
  ('0303.89.45', 'Peixes-rei (<i>Atherina</i> spp.)'),
  ('0303.89.46', 'Nototenias (<i>Patagonotothen</i> spp.)'),
  ('0303.89.51', 'Curimatãs (<i>Prochilodus</i> spp.)'),
  ('0303.89.52', 'Tilápias (<i>Tilapia</i> spp.<i>, Sarotherodon</i> spp.<i>, Danakilia</i> spp.; seus híbridos)'),
  ('0303.89.53', 'Surubins (<i>Pseudoplatystoma</i> spp.)'),
  ('0303.89.54', 'Traíra (<i>Hoplias malabaricus & H. cf. lacerdae</i>)'),
  ...
  ('0303.89.65', 'Tambacu (híbrido de tambaqui e pacu)'),
  ('0303.89.90', 'Outros'),
  ('0303.91.10', 'Ovas de tainhas (<i>Mugil</i> spp.)'),
  ('0303.91.90', 'Outros'),
  ('0303.92.00', '-- Barbatanas de tubarão'),
  ('0303.99.10', 'Cabeças de Merluza negra (<i>Dissostichus eleginoides</i>)'),
  ('0303.99.20', 'Cabeças de Merluza antártica (<i>Dissostichus mawsoni</i>)'),
  ('0303.99.90', 'Outros'),
  ('0304.31.00', '-- Tilápias (<i>Oreochromis</i> spp.)'),
  ('0304.32.10', 'Bagre americano (<i>Ictalurus punctatus</i>)'),
  ('0304.32.90', 'Outros'),
  ('0304.33.00', '-- Perca-do-nilo (<i>Lates niloticus</i>)'),
  ('0304.39.00', '-- Outros'),
  ('0304.41.00', '-- Salmões-do-pacífico (<i>Oncorhynchus nerka, Oncorhynchus gorbuscha, Oncorhynchus keta, Oncorhynchus tschawytscha, Oncorhynchus kisutch, Oncorhynchus masou</i> e <i>Oncorhynchus rhodurus</i>), salmão-do-atlântico (<i>Salmo salar</i>) e salmão-do-danúbio (<i>Hucho hucho</i>)'),
  ...
  ('0304.44.00', '-- Peixes das famílias <i>Bregmacerotidae, Euclichthyidae, Gadidae, Macrouridae, Melanonidae, Merlucciidae, Moridae</i> e <i>Muraenolepididae</i>'),
  ('0304.45.00', '-- Espadarte (<i>Xiphias gladius</i>)'),
  ('0304.46.00', '-- Merluza negra e merluza antártica (Marlongas*) (<i>Dissostichus</i> spp.)'),
  ...
  ('0304.49.90', 'Outros'),
  ('0304.51.00', '-- Tilápias (<i>Oreochromis</i> spp.), bagres (peixes-gato*) (<i>Pangasius</i> spp., <i>Silurus</i> spp., <i>Clarias</i> spp., <i>Ictalurus</i> spp.), carpas (<i>Cyprinus</i> spp., <i>Carassius</i> spp., <i>Ctenopharyngodon idellus</i>, <i>Hypophthalmichthys</i> spp., <i>Cirrhinus</i> spp., <i>Mylopharyngodon piceus</i>, <i>Catla catla</i>, <i>Labeo</i> spp., <i>Osteochilus hasselti</i>, <i>Leptobarbus hoeveni</i>, <i>Megalobrama</i> spp.), enguias (<i>Anguilla</i> spp.), perca-do-nilo (<i>Lates niloticus</i>) e peixes cabeça-de-serpente (<i>Channa</i> spp.)'),
  ('0304.52.00', '-- Salmonídeos'),
  ('0304.53.00', '-- Peixes das famílias <i>Bregmacerotidae, Euclichthyidae, Gadidae, Macrouridae, Melanonidae, Merlucciidae, Moridae</i> e <i>Muraenolepididae</i>'),
  ('0304.54.00', '-- Espadarte (<i>Xiphias gladius</i>)'),
  ('0304.55.00', '-- Merluza negra e merluza antártica (Marlongas*) (<i>Dissostichus</i> spp.)'),
  ('0304.56.00', '-- Cação e outros tubarões'),
  ('0304.57.00', '-- Raias (<i>Rajidae</i>)'),
  ('0304.59.00', '-- Outros'),
  ('0304.61.00', '-- Tilápias (<i>Oreochromis</i> spp.)'),
  ('0304.62.10', 'Bagre americano (<i>Ictalurus punctatus</i>)'),
  ('0304.62.90', 'Outros'),
  ('0304.63.00', '-- Perca-do-nilo (<i>Lates niloticus</i>)'),
  ('0304.69.00', '-- Outros'),
  ('0304.71.00', '-- Bacalhau-do-atlântico (<i>Gadus morhua</i>), bacalhau-da-groelândia (<i>Gadus ogac</i>) e bacalhau-do-pacífico (<i>Gadus macrocephalus</i>)'),
  ('0304.72.00', '-- Hadoque (Arinca*) (<i>Melanogrammus aeglefinus</i>)'),
  ('0304.73.00', '-- Saithe (Escamudo*) (<i>Pollachius virens</i>)'),
  ('0304.74.00', '-- Merluzas (Pescadas*) e abróteas (<i>Merluccius</i> spp.<i>, Urophycis</i> spp.)'),
  ('0304.75.00', '-- Polaca-do-alasca (Escamudo-do-alasca*) (<i>Theragra chalcogramma</i>)'),
  ('0304.79.00', '-- Outros'),
  ('0304.81.00', '-- Salmões-do-pacífico (<i>Oncorhynchus nerka, Oncorhynchus gorbuscha, Oncorhynchus keta, Oncorhynchus tschawytscha, Oncorhynchus kisutch, Oncorhynchus masou</i> e <i>Oncorhynchus rhodurus</i>), salmão-do-atlântico (<i>Salmo salar</i>) e salmão-do-danúbio (<i>Hucho hucho</i>)'),
  ...
  ('0304.85.20', 'Merluza antártica (<i>Dissostichus mawsoni</i>)'),
  ('0304.86.00', '-- Arenques (<i>Clupea harengus, Clupea pallasii</i>)'),
  ('0304.87.00', '-- Atuns (do gênero <i>Thunnus</i>), bonito-listrado (gaiado*) (<i>Katsuwonus pelamis</i>)'),
  ('0304.88.10', 'Tubarão-azul (<i>Prionace glauca</i>)'),
  ('0304.88.90', 'Outros'),
  ...
  ('0304.92.29', 'Outros'),
  ('0304.93.00', '-- Tilápias (<i>Oreochromis</i> spp.), bagres (peixes-gato*) (<i>Pangasius</i> spp.<i>, Silurus</i> spp.<i>, Clarias</i> spp.<i>, Ictalurus</i> spp.), carpas (<i>Cyprinus</i> spp.<i>, Carassius</i> spp.<i>, Ctenopharyngodon idellus, Hypophthalmichthys</i> spp.<i>, Cirrhinus</i> spp.<i>, Mylopharyngodon piceus, Catla catla, Labeo</i> spp.<i>, Osteochilus hasselti, Leptobarbus hoeveni, Megalobrama</i> spp.), enguias (<i>Anguilla</i> spp.), perca-do-nilo (<i>Lates niloticus</i>) e peixes cabeça-de-serpente (<i>Channa</i> spp.)'),
  ('0304.94.00', '-- Polaca-do-alasca (Escamudo-do-alasca*) (<i>Theragra chalcogramma</i>)'),
  ('0304.95.00', '-- Peixes das famílias <i>Bregmacerotidae, Euclichthyidae, Gadidae, Macrouridae, Melanonidae, Merlucciidae, Moridae</i> e <i>Muraenolepididae</i>, exceto a polaca-do-alasca (escamudo-do-alasca*) (<i>Theragra chalcogramma</i>)'),
  ('0304.96.00', '-- Cação e outros tubarões'),
  ('0304.97.00', '-- Raias (<i>Rajidae</i>)'),
  ('0304.99.00', '-- Outros'),
  ('0305.20.10', 'Ovas de tainhas (<i>Mugil</i> spp.)'),
  ('0305.20.90', 'Outros'),
  ('0305.31.00', '-- Tilápias (<i>Oreochromis</i> spp.), bagres (peixes-gato*) (<i>Pangasius</i> spp.<i>, Silurus</i> spp.<i>, Clarias</i> spp.<i>, Ictalurus</i> spp.), carpas (<i>Cyprinus</i> spp.<i>, Carassius</i> spp.<i>, Ctenopharyngodon idellus, Hypophthalmichthys</i> spp.<i>, Cirrhinus</i> spp.<i>, Mylopharyngodon piceus, Catla catla, Labeo</i> spp.<i>, Osteochilus hasselti, Leptobarbus hoeveni, Megalobrama</i> spp.), enguias (<i>Anguilla</i> spp.), perca-do-nilo (<i>Lates niloticus</i>) e peixes cabeça-de-serpente (<i>Channa</i> spp.)'),
  ('0305.32.10', 'Bacalhau-do-atlântico (<i>Gadus morhua</i>), bacalhau-da-groelândia (<i>Gadus ogac</i>) e bacalhau-do-pacífico (<i>Gadus macrocephalus</i>)'),
  ('0305.32.20', 'Saithe (<i>Pollachius virens</i>)'),
  ('0305.32.30', 'Ling (<i>Molva molva</i>) e zarbo (<i>Brosme brosme</i>)'),
  ('0305.32.90', 'Outros'),
  ('0305.39.00', '-- Outros'),
  ('0305.41.00', '-- Salmões-do-pacífico (<i>Oncorhynchus nerka, Oncorhynchus gorbuscha, Oncorhynchus keta, Oncorhynchus tschawytscha, Oncorhynchus kisutch, Oncorhynchus masou</i> e <i>Oncorhynchus rhodurus</i>), salmão-do-atlântico (<i>Salmo salar</i>) e salmão-do-danúbio (<i>Hucho hucho</i>)'),
  ...
  ('0305.44.00', '-- Tilápias (<i>Oreochromis</i> spp.), bagres (peixes-gato*) (<i>Pangasius</i> spp.<i>, Silurus</i> spp.<i>, Clarias</i> spp.<i>, Ictalurus</i> spp.), carpas (<i>Cyprinus</i> spp.<i>, Carassius</i> spp.<i>, Ctenopharyngodon idellus, Hypophthalmichthys</i> spp.<i>, Cirrhinus</i> spp.<i>, Mylopharyngodon piceus, Catla catla, Labeo</i> spp.<i>, Osteochilus hasselti, Leptobarbus hoeveni, Megalobrama</i> spp.), enguias (<i>Anguilla</i> spp.), perca-do-nilo (<i>Lates niloticus</i>) e peixes cabeça-de-serpente (<i>Channa</i> spp.)'),
  ('0305.49.10', 'Bacalhau-do-atlântico (<i>Gadus morhua</i>), bacalhau-da-groelândia (<i>Gadus ogac</i>) e bacalhau-do-pacífico (<i>Gadus macrocephalus</i>)'),
  ('0305.49.20', 'Saithe (<i>Pollachius virens</i>), ling (<i>Molva molva</i>) e zarbo (<i>Brosme brosme</i>)'),
  ('0305.49.90', 'Outros'),
  ('0305.51.00', '-- Bacalhau-do-atlântico (<i>Gadus morhua</i>), bacalhau-da-groelândia (<i>Gadus ogac</i>) e bacalhau-do-pacífico (<i>Gadus macrocephalus</i>)'),
  ('0305.52.00', '-- Tilápias (<i>Oreochromis</i> spp.), bagres (peixes-gato*) (<i>Pangasius</i> spp.<i>, Silurus</i> spp.<i>, Clarias</i> spp.<i>, Ictalurus</i> spp.), carpas (<i>Cyprinus</i> spp.<i>, Carassius</i> spp.<i>, Ctenopharyngodon idellus, Hypophthalmichthys</i> spp.<i>, Cirrhinus</i> spp.<i>, Mylopharyngodon piceus, Catla catla, Labeo</i> spp.<i>, Osteochilus hasselti, Leptobarbus hoeveni, Megalobrama</i> spp.), enguias (<i>Anguilla</i> spp.), perca-do-nilo (<i>Lates niloticus</i>) e peixes cabeça-de-serpente (<i>Channa</i> spp.)'),
  ...
  ('0305.62.00', '-- Bacalhau-do-atlântico (<i>Gadus morhua</i>), bacalhau-da-groelândia (<i>Gadus ogac</i>) e bacalhau-do-pacífico (<i>Gadus macrocephalus</i>)'),
  ('0305.63.00', '-- Anchovas (Biqueirões*) (<i>Engraulis</i> spp.)'),
  ('0305.64.00', '-- Tilápias (<i>Oreochromis</i> spp.), bagres (peixes-gato*) (<i>Pangasius</i> spp.<i>, Silurus</i> spp.<i>, Clarias</i> spp.<i>, Ictalurus</i> spp.), carpas (<i>Cyprinus</i> spp.<i>, Carassius</i> spp.<i>, Ctenopharyngodon idellus, Hypophthalmichthys</i> spp.<i>, Cirrhinus</i> spp.<i>, Mylopharyngodon piceus, Catla catla, Labeo</i> spp.<i>, Osteochilus hasselti, Leptobarbus hoeveni, Megalobrama</i> spp.), enguias (<i>Anguilla</i> spp.), perca-do-nilo (<i>Lates niloticus</i>) e peixes cabeça-de-serpente (<i>Channa</i> spp.)'),
  ...
  ('0306.35.00', '-- Camarões de água fria (<i>Pandalus</i> spp., <i>Crangon crangon</i>)'),
  ('0306.36.00', '-- Outros camarões'),
  ('0306.39.10', 'Lagosta de água doce (<i>Cherax quadricarinatus</i>)'),
  ('0306.39.90', 'Outros'),
  ...
  ('0306.95.00', '-- Camarões'),
  ('0306.99.10', 'Lagosta de água doce (<i>Cherax quadricarinatus</i>)'),
  ('0306.99.90', 'Outros'),
  ...
  ('0308.29.00', '-- Outros'),
  ('0308.30.00', '- Medusas (águas-vivas) (<i>Rhopilema</i> spp.)'),
  ('0308.90.00', '- Outros'),
  ('0309.10.00', '- De peixe'),
  ('0309.90.00', '- Outros'),
  ...
  ('0405.90.10', 'Óleo butírico de manteiga (<i>butter oil</i>)'),
  ('0405.90.90', 'Outras'),
  ('0406.10.10', 'Mozarela'),
  ('0406.10.90', 'Outros'),
  ...
  ('0406.90.90', 'Outros'),
  ('0407.11.00', '-- De aves da espécie <i>Gallus domesticus</i>')
ON CONFLICT (codigo) DO NOTHING;

INSERT INTO public.ncm (codigo, descricao) VALUES
  ('0407.19.00', '-- Outros'),
  ('0407.21.00', '-- De aves da espécie <i>Gallus domesticus</i>'),
  ('0407.29.00', '-- Outros'),
  ('0407.90.00', '- Outros'),
  ('0408.11.00', '-- Secas'),
  ('0408.19.00', '-- Outras'),
  ...
  ('0603.15.00', '-- Lírios (<i>Lilium</i> spp.)'),
  ('0603.19.00', '-- Outros'),
  ('0603.90.00', '- Outros'),
  ('0604.20.00', '- Frescos'),
  ('0604.90.00', '- Outros'),
  ...
  ('0705.19.00', '-- Outra'),
  ('0705.21.00', '-- Endívia (<i>Cichorium intybus</i> var. <i>foliosum</i>)'),
  ('0705.29.00', '-- Outras'),
  ...
  ('0708.20.00', '- Feijões (<i>Vigna</i> spp., <i>Phaseolus</i> spp.)'),
  ('0708.90.00', '- Outros legumes de vagem'),
  ('0709.20.00', '- Aspargos'),
  ('0709.30.00', '- Berinjelas'),
  ('0709.40.00', '- Aipo, exceto aipo-rábano'),
  ('0709.51.00', '-- Cogumelos do gênero <i>Agaricus</i>'),
  ('0709.52.00', '-- Cogumelos do gênero <i>Boletus</i>'),
  ('0709.53.00', '-- Cogumelos do gênero <i>Cantharellus</i>'),
  ...
  ('0709.59.00', '-- Outros'),
  ('0709.60.00', '- Pimentões (pimentos) e pimentas do gênero <i>Capsicum</i> ou do gênero <i>Pimenta</i>'),
  ('0709.70.00', '- Espinafres, espinafres-da-nova-zelândia e espinafres gigantes'),
  ('0709.91.00', '-- Alcachofras'),
  ('0709.92.00', '-- Azeitonas'),
  ('0709.93.00', '-- Abóboras, abobrinhas (curgetes*) e cabaças (<i>Cucurbita</i> spp.)'),
  ('0709.99.11', 'Para semeadura (sementeira)'),
  ('0709.99.19', 'Outros'),
  ('0709.99.90', 'Outros'),
  ('0710.10.00', '- Batatas'),
  ('0710.21.00', '-- Ervilhas (<i>Pisum sativum</i>)'),
  ('0710.22.00', '-- Feijões (<i>Vigna</i> spp., <i>Phaseolus</i> spp.)'),
  ('0710.29.00', '-- Outros'),
  ...
  ('0711.51.00', '-- Cogumelos do gênero <i>Agaricus</i>'),
  ('0711.59.00', '-- Outros'),
  ('0711.90.00', '- Outros produtos hortícolas; misturas de produtos hortícolas'),
  ('0712.20.00', '- Cebolas'),
  ('0712.31.00', '-- Cogumelos do gênero <i>Agaricus</i>'),
  ...
  ('0805.50.00', '- Limões (<i>Citrus limon, Citrus limonum</i>) e limas (<i>Citrus aurantifolia, Citrus latifolia</i>)'),
  ('0805.90.00', '- Outros'),
  ('0806.10.00', '- Frescas'),
  ...
  ('0810.40.00', '- Airelas, mirtilos e outra fruta do gênero <i>Vaccinium</i>'),
  ...
  ('0810.90.15', 'Maracujás (<i>Passiflora edulis</i>)'),
...
INSERT INTO public.ncm (codigo, descricao) VALUES
  ...
  ('1008.90.90', 'Outros'),
  ('1101.00.10', 'De trigo'),
  ('1101.00.20', 'De mistura de trigo com centeio (<i>méteil</i>)'),
  ...
  ('1105.20.00', '- Flocos, grânulos e <i>pellets</i>'),
  ...
  ('1209.25.00', '-- Sementes de azevém (<i>Lolium multiflorum Lam., Lolium perenne</i> L.)'),
  ('1209.29.00', '-- Outras'),
  ...
  ('1209.99.00', '-- Outros'),
  ('1210.10.00', '- Cones de lúpulo, não triturados nem moídos nem em <i>pellets</i>'),
  ...
  ('1211.90.10', 'Orégano (<i>Origanum vulgare</i>)'),
  ('1211.90.90', 'Outros'),
  ...
  ('1212.99.10', 'Estévia (<i>Ka''a He''ẽ</i>) (<i>Stevia rebaudiana</i>)'),
  ('1212.99.90', 'Outros'),
  ('1213.00.00', 'Palhas e cascas de cereais, em bruto, mesmo picadas, moídas, prensadas ou em <i>pellets</i>.'),
  ...
  ('1302.19.10', 'De mamão (<i>Carica papaya</i>), seco'),
  ...
  ('1302.19.91', 'De píretro ou de raízes de plantas que contenham rotenona'),
  ('1302.19.99', 'Outros'),
  ...
  ('1404.20.10', 'Em bruto'),
  ('1404.20.90', 'Outros'),
  ('1404.90.10', 'Matérias vegetais das espécies principalmente utilizadas na fabricação de vassouras, escovas, pincéis e artigos semelhantes (por exemplo, sorgo, piaçaba, raiz de grama (relva), tampico), mesmo em torcidas ou em feixes'),
  ('1404.90.90', 'Outros'),
  ('1501.10.00', '- Banha'),
...
INSERT INTO public.ncm (codigo, descricao) VALUES
  ...
  ('1521.90.19', 'Outras'),
  ('1521.90.90', 'Outros'),
  ('1522.00.00', '<i>Dégras</i>; resíduos provenientes do tratamento das substâncias gordas ou das ceras animais ou vegetais.'),
  ...
  ('1904.90.00', '- Outros'),
  ('1905.10.00', '- Pão crocante denominado <i>knäckebrot</i>'),
  ('1905.20.10', 'Panetone'),
  ('1905.20.90', 'Outros'),
  ...
  ('2002.90.00', '- Outros'),
  ('2003.10.00', '- Cogumelos do gênero <i>Agaricus</i>'),
  ('2003.90.00', '- Outros'),
  ('2004.10.00', '- Batatas'),
  ...
  ('2007.99.21', 'De açaí (<i>Euterpe oleracea</i>)'),
  ...
  ('2007.99.26', 'De cupuaçu (<i>Theobroma grandiflorum</i>)'),
  ('2007.99.27', 'De mamão (papaia) (<i>Carica papaya L.</i>)'),
  ('2007.99.29', 'Outros'),
  ('2007.99.90', 'Outros'),
  ...
  ('2009.89.13', 'De maracujá (<i>Passiflora edulis</i>)'),
  ('2009.89.19', 'Outros'),
...
INSERT INTO public.ncm (codigo, descricao) VALUES
  ...
  ('2304.00.90', 'Outros'),
  ('2305.00.00', 'Tortas (bagaços) e outros resíduos sólidos, mesmo triturados ou em <i>pellets</i>, da extração do óleo de amendoim.'),
  ('2306.10.00', '- De sementes de algodão'),
  ('2306.20.00', '- De linhaça (sementes de linho)'),
  ('2306.30.10', 'Tortas (bagaços), farinhas e <i>pellets</i>'),
  ('2306.30.90', 'Outros'),
  ...
  ('2308.00.00', 'Matérias vegetais e desperdícios vegetais, resíduos e subprodutos vegetais, mesmo em <i>pellets</i>, do tipo utilizado na alimentação de animais, não especificados nem compreendidos noutras posições.'),
  ...
  ('2309.90.70', 'Preparações com um teor de vitamina B<sub>12</sub> igual ou superior a 0,1 %, mas não superior a 1 %, em peso, com suporte à base de carbonato de cálcio'),
  ('2309.90.90', 'Outras'),
  ('2401.10.10', 'Em folhas, sem secar nem fermentar'),
  ('2401.10.20', 'Em folhas secas ou fermentadas tipo capeiro'),
  ('2401.10.30', 'Em folhas secas em secador de ar quente (<i>flue cured</i>), do tipo Virgínia'),
  ...
  ('2401.20.30', 'Em folhas secas em secador de ar quente (<i>flue cured</i>), do tipo Virgínia'),
  ...
  ('2508.40.10', 'Plásticas, com um teor de Fe<sub>2</sub>O<sub>3</sub>, em peso, inferior a 1,5 % e com perda por calcinação, em peso, superior a 12 %'),
  ('2508.40.90', 'Outras'),
  ('2508.50.00', '- Andaluzita, cianita e silimanita'),
  ('2508.60.00', '- Mulita'),
  ('2508.70.00', '- Barro cozido em pó (terra de <i>chamotte</i>) e terra de dinas'),
  ('2509.00.00', 'Cré.'),
  ...
  ('2512.00.00', 'Farinhas siliciosas fósseis (por exemplo, <i>kieselguhr</i>, tripolita, diatomita) e outras terras siliciosas análogas de densidade aparente não superior a 1, mesmo calcinadas.'),
  ...
  ('2523.10.00', '- Cimentos não pulverizados, denominados <i>clinkers</i>'),
  ...
  ('2528.00.00', 'Boratos naturais e seus concentrados (calcinados ou não), exceto boratos extraídos de salmouras naturais; ácido bórico natural com um teor máximo de 85 % de H<sub>3</sub>BO<sub>3</sub>, em produto seco.'),
  ...
  ('2601.12.20', 'Em briquetes de volume igual ou superior a 4 cm³, mas não superior a 60 cm³'),
  ('2601.12.90', 'Outros'),
  ...
  ('2620.99.10', 'Que contenham principalmente titânio'),
  ('2620.99.90', 'Outros'),
...
INSERT INTO public.ncm (codigo, descricao) VALUES
  ...
  ('2710.12.29', 'Outras'),
  ('2710.12.30', 'Aguarrás mineral (<i>white spirit</i>)'),
  ...
  ('2714.90.00', '- Outros'),
  ('2715.00.00', 'Misturas betuminosas à base de asfalto ou de betume naturais, de betume de petróleo, de alcatrão mineral ou de breu de alcatrão mineral (por exemplo, mástiques betuminosas e <i>cut-backs</i>).'),
  ...
  ('2805.19.20', 'Bário'),
  ('2805.19.90', 'Outros'),
  ('2805.30.10', 'Liga de cério, com um teor de ferro inferior ou igual a 5 %, em peso (<i>Mischmetal</i>)'),
  ('2805.30.90', 'Outros'),
  ('2805.40.00', '- Mercúrio'),
  ...
  ('2820.10.10', 'Com um teor de MnO<sub>2</sub> igual ou superior a 91 %, em peso (manganês eletrolítico)'),
  ('2820.10.90', 'Outros'),
  ...
  ('2821.10.11', 'Com um teor de Fe<sub>2</sub>O<sub>3</sub> igual ou superior a 85 %, em peso'),
  ('2821.10.19', 'Outros'),
  ('2821.10.20', 'Óxido ferroso-férrico (óxido magnético de ferro), com um teor de Fe<sub>3</sub>O<sub>4</sub> igual ou superior a 93 %, em peso'),
  ('2821.10.30', 'Hidróxidos de ferro'),
  ('2821.10.90', 'Outros'),
  ('2821.20.00', '- Terras corantes'),
  ('2822.00.10', 'Tetraóxido de tricobalto (óxido salino de cobalto)'),
  ('2822.00.90', 'Outros'),
  ('2823.00.10', 'Tipo anátase'),
  ('2823.00.90', 'Outros'),
  ('2824.10.00', '- Monóxido de chumbo (litargírio, massicote)'),
  ('2824.90.10', 'Mínio (zarcão) e mínio-laranja (<i>mine-orange</i>)'),
  ('2824.90.90', 'Outros'),
  ...
  ('2825.40.90', 'Outros'),
  ('2825.50.10', 'Óxido cúprico, com um teor de CuO igual ou superior a 98 %, em peso'),
  ('2825.50.90', 'Outros'),
  ...
  ('2826.19.90', 'Outros'),
  ('2826.30.00', '- Hexafluoraluminato de sódio (criolita sintética)'),
  ('2826.90.10', 'Fluoroaluminato de potássio'),
  ('2826.90.20', 'Fluorossilicatos de sódio ou de potássio'),
  ('2826.90.90', 'Outros'),
  ('2827.10.00', '- Cloreto de amônio'),
  ('2827.20.10', 'Com um teor de CaCl<sub>2</sub> igual ou superior a 98 %, em peso, em base seca'),
  ('2827.20.90', 'Outros'),
  ('2827.31.10', 'Com um teor de MgCl<sub>2</sub> inferior a 98 %, em peso, e de cálcio (Ca) inferior ou igual a 0,5 %, em peso'),
  ('2827.31.90', 'Outros'),
  ...
  ('2827.39.31', 'Anidro, com um teor de ZnCl<sub>2</sub> igual ou superior a 98 %, em peso'),
  ('2827.39.39', 'Outros'),
...
INSERT INTO public.ncm (codigo, descricao) VALUES
  ...
  ('2833.25.10', 'Cuproso'),
  ('2833.25.20', 'Cúprico'),
  ('2833.27.10', 'Com um teor de BaSO<sub>4</sub> igual ou superior a 97,5 %, em peso'),
  ('2833.27.90', 'Outros'),
  ...
  ('2834.10.10', 'De sódio'),
  ('2834.10.90', 'Outros'),
  ('2834.21.10', 'Com um teor de KNO<sub>3</sub> inferior ou igual a 98 %, em peso'),
  ('2834.21.90', 'Outros'),
  ('2834.29.10', 'De cálcio, com um teor de nitrogênio (azoto) inferior ou igual a 16 %, em peso'),
  ...
  ('2835.29.90', 'Outros'),
  ('2835.31.10', 'Grau alimentício, de acordo com o estabelecido pela <i>Food and Agriculture Organization</i> - Organização Mundial da Saúde (FAO - OMS) ou pelo <i>Food Chemical Codex</i> (FCC)'),
  ('2835.31.90', 'Outros'),
  ...
  ('2836.60.10', 'Com um teor de BaCO<sub>3</sub> igual ou superior a 98 %, em peso'),
  ('2836.60.90', 'Outros'),
  ('2836.91.00', '-- Carbonatos de lítio'),
  ('2836.92.00', '-- Carbonato de estrôncio'),
  ('2836.99.11', 'De magnésio, de densidade aparente inferior a 200 kg/m<sup>3</sup>'),
  ...
  ('2843.90.19', 'Outros'),
  ('2843.90.20', 'Tricloreto de rutênio em solução aquosa com uma concentração igual ou superior a 17 %, mas inferior ou igual a 27 %, em peso'),
  ...
  ('2843.90.90', 'Outros'),
  ('2844.10.00', '- Urânio natural e seus compostos; ligas, dispersões (incluindo os <i>cermets</i>), produtos cerâmicos e misturas que contenham urânio natural ou compostos de urânio natural'),
  ('2844.20.00', '- Urânio enriquecido em U 235 e seus compostos; plutônio e seus compostos; ligas, dispersões (incluindo os <i>cermets</i>), produtos cerâmicos e misturas que contenham urânio enriquecido em U 235, plutônio ou compostos destes produtos'),
  ('2844.30.00', '- Urânio empobrecido em U 235 e seus compostos; tório e seus compostos; ligas, dispersões (incluindo os <i>cermets</i>), produtos cerâmicos e misturas que contenham urânio empobrecido em U 235, tório ou compostos destes produtos'),
  ('2844.41.00', '-- Trítio e seus compostos; ligas, dispersões (incluindo os <i>cermets</i>), produtos cerâmicos e misturas que contenham trítio ou seus compostos'),
  ('2844.42.00', '-- Actínio-225, actínio-227, califórnio-253, cúrio-240, cúrio-241, cúrio-242, cúrio-243, cúrio-244, einstêinio-253, einstêinio-254, gadolínio-148, polônio-208, polônio-209, polônio-210, rádio-223, urânio-230 ou urânio-232, e seus compostos; ligas, dispersões (incluindo os <i>cermets</i>), produtos cerâmicos e misturas que contenham estes elementos ou compostos'),
  ...
  ('2901.23.00', '-- Buteno (butileno) e seus isômeros'),
...
INSERT INTO public.ncm (codigo, descricao) VALUES
  ...
  ('2902.44.00', '-- Mistura de isômeros do xileno'),
  ('2902.50.00', '- Estireno'),
  ...
  ('2903.79.19', 'Outros'),
  ('2903.79.20', 'Derivados do metano, etano ou propano, halogenados unicamente com flúor e bromo'),
  ('2903.79.31', 'Halotano'),
  ('2903.79.39', 'Outros'),
  ('2903.79.90', 'Outros'),
  ...
  ('2904.10.30', 'Ácidos toluenossulfônicos; ácidos xilenossulfônicos; sais destes ácidos'),
  ('2904.10.40', 'Ácido etanossulfônico; ácido etilenossulfônico'),
  ('2904.10.51', 'Naftalenossulfonatos de sódio'),
  ('2904.10.52', 'Ácido beta-naftalenossulfônico'),
  ('2904.10.53', 'Ácidos alquil- e dialquilnaftalenossulfônicos; sais destes ácidos'),
  ('2904.10.59', 'Outros'),
  ('2904.10.60', 'Ácido benzenossulfônico e seus sais'),
  ('2904.10.90', 'Outros'),
  ...
  ('2904.20.90', 'Outros'),
  ('2904.31.00', '-- Ácido perfluoroctano sulfônico'),
  ('2904.32.00', '-- Perfluoroctanossulfonato de amônio'),
  ('2904.33.00', '-- Perfluoroctanossulfonato de lítio'),
  ('2904.34.00', '-- Perfluoroctanossulfonato de potássio'),
  ('2904.35.00', '-- Outros sais do ácido perfluoroctano sulfônico'),
  ...
  ('2904.99.19', 'Outros'),
  ('2904.99.21', 'Ácidos dinitroestilbenodissulfônicos'),
  ('2904.99.29', 'Outros'),
  ...
  ('2905.12.10', 'Álcool propílico'),
  ('2905.12.20', 'Álcool isopropílico'),
  ('2905.13.00', '-- Butan-1-ol (álcool <i>n</i>-butílico)'),
  ('2905.14.10', 'Álcool isobutílico (2-metil-1-propanol)'),
  ('2905.14.20', 'Álcool <i>sec</i>-butílico (2-butanol)'),
  ('2905.14.30', 'Álcool <i>ter</i>-butílico (2-metil-2-propanol)'),
  ('2905.16.00', '-- Octanol (álcool octílico) e seus isômeros'),
  ('2905.17.10', 'Álcool láurico'),
  ('2905.17.20', 'Álcool cetílico'),
  ('2905.17.30', 'Álcool esteárico'),
  ...
  ('2905.19.95', '3,3-Dimetilbutan-2-ol (álcool pinacolílico)'),
  ('2905.19.96', 'Pentanol (álcool amílico) e seus isômeros'),
  ('2905.19.99', 'Outros'),
  ('2905.22.10', 'Linalol'),
  ('2905.22.20', 'Geraniol'),
  ('2905.22.30', 'Di-hidromircenol (2,6-dimetil-7-octen-2-ol)'),
  ('2905.22.90', 'Outros'),
  ('2905.29.10', 'Álcool alílico'),
  ('2905.29.90', 'Outros'),
  ...
  ('2905.59.90', 'Outros'),
  ('2906.11.00', '-- Mentol'),
  ('2906.12.00', '-- Cicloexanol, metilcicloexanóis e dimetilcicloexanóis'),
  ('2906.13.00', '-- Esteróis e inositóis'),
  ('2906.19.10', 'Derivados do mentol'),
  ('2906.19.20', 'Borneol; isoborneol'),
  ('2906.19.30', 'Terpina e seu hidrato'),
  ('2906.19.40', 'Álcool fenchílico (1,3,3-trimetil-2-norbornanol)'),
  ('2906.19.50', 'Terpineóis'),
  ('2906.19.90', 'Outros'),
  ...
  ('2907.12.00', '-- Cresóis e seus sais'),
  ...
  ('2907.19.40', 'Xilenóis e seus sais'),
  ('2907.19.90', 'Outros'),
  ...
  ('2908.19.12', 'Diclorofenóis e seus sais'),
  ('2908.19.13', '<i>p</i>-Clorofenol'),
  ('2908.19.14', 'Triclorofenóis e seus sais'),
  ('2908.19.15', 'Tetraclorofenóis e seus sais'),
...
INSERT INTO public.ncm (codigo, descricao) VALUES
  ('2909.19.10', 'Éter metil-<i>ter</i>-butílico (MTBE)'),
  ('2909.19.20', 'Sevoflurano'),
  ('2909.19.90', 'Outros'),
  ('2909.20.00', '- Éteres ciclânicos, ciclênicos, cicloterpênicos e seus derivados halogenados, sulfonados, nitrados ou nitrosados'),
  ('2909.30.11', 'Anetol'),
  ...
  ('2909.49.49', 'Outros'),
  ('2909.49.50', 'Álcoois fenoxibenzílicos'),
  ('2909.49.90', 'Outros'),
  ...
  ('2910.20.00', '- Metiloxirano (óxido de propileno)'),
  ('2910.30.00', '- 1-Cloro-2,3-epoxipropano (epicloridrina)'),
  ('2910.40.00', '- Dieldrin (ISO, DCI)'),
  ('2910.50.00', '- Endrin (ISO)'),
  ('2910.90.10', 'Óxido de estireno'),
  ('2910.90.90', 'Outros'),
  ('2911.00.10', 'Dimetilacetal do 2-nitrobenzaldeído'),
  ('2911.00.90', 'Outros'),
  ('2912.11.00', '-- Metanal (formaldeído)'),
  ('2912.12.00', '-- Etanal (acetaldeído)'),
  ('2912.19.11', 'Glioxal'),
  ('2912.19.12', 'Glutaraldeído'),
  ('2912.19.19', 'Outros'),
  ('2912.19.21', 'Citral'),
  ...
  ('2912.19.91', 'Heptanal'),
  ('2912.19.99', 'Outros'),
  ('2912.21.00', '-- Benzaldeído (aldeído benzoico)'),
  ('2912.29.10', 'Aldeído alfa-amilcinâmico'),
  ('2912.29.20', 'Aldeído alfa-hexilcinâmico'),
  ('2912.29.90', 'Outros'),
  ('2912.41.00', '-- Vanilina (aldeído metilprotocatéquico)'),
  ('2912.42.00', '-- Etilvanilina (aldeído etilprotocatéquico)'),
  ('2912.49.10', '3-Fenoxibenzaldeído'),
  ('2912.49.20', '3-Hidroxibenzaldeído'),
  ('2912.49.30', '3,4,5-Trimetoxibenzaldeído'),
  ('2912.49.41', '4-(4-Hidroxi-4-metilpentil)-3-cicloexeno-1-carboxialdeído'),
  ('2912.49.49', 'Outros'),
  ('2912.49.90', 'Outros'),
  ('2912.50.00', '- Polímeros cíclicos dos aldeídos'),
  ('2912.60.00', '- Paraformaldeído'),
  ...
  ('2914.50.20', '1,8-Di-hidroxi-3-metil-9-antrona e sua forma enólica (crisarobina ou <i>chrysarobin</i>)'),
  ('2914.50.90', 'Outras'),
  ...
  ('2916.31.39', 'Outros'),
  ('2916.32.10', 'Peróxido de benzoíla'),
  ('2916.32.20', 'Cloreto de benzoíla'),
  ('2916.34.00', '-- Ácido fenilacético e seus sais'),
  ...
  ('2916.39.90', 'Outros'),
  ('2917.11.10', 'Ácido oxálico e seus sais'),
  ('2917.11.20', 'Ésteres'),
  ('2917.12.10', 'Ácido adípico'),
  ('2917.12.20', 'Sais e ésteres'),
  ('2917.13.10', 'Ácido azelaico, seus sais e seus ésteres'),
  ('2917.13.21', 'Ácido sebácico'),
  ...
  ('2917.19.21', 'Ácido maleico')
ON CONFLICT (codigo) DO NOTHING;

INSERT INTO public.ncm (codigo, descricao) VALUES
  ('2917.19.22', 'Sais e ésteres'),
  ('2917.19.30', 'Ácido fumárico, seus sais e seus ésteres'),
  ('2917.19.90', 'Outros'),
  ...
  ('2917.34.00', '-- Outros ésteres do ácido ortoftálico'),
  ...
  ('2918.16.90', 'Outros'),
  ('2918.17.00', '-- Ácido 2,2-difenil-2-hidroxiacético (ácido benzílico)'),
  ('2918.18.00', '-- Clorobenzilato (ISO)'),
  ('2918.19.10', 'Bromopropilato'),
  ('2918.19.21', 'Ursodiol (ácido ursodeoxicólico)'),
  ('2918.19.22', 'Ácido quenodeoxicólico'),
  ('2918.19.29', 'Outros'),
  ('2918.19.30', 'Ácido 12-hidroxiesteárico'),
  ('2918.19.42', 'Sais'),
  ('2918.19.43', 'Ésteres'),
  ('2918.19.90', 'Outros'),
  ('2918.21.10', 'Ácido salicílico'),
  ('2918.21.20', 'Sais'),
  ('2918.22.11', 'Ácido <i>o</i>-acetilsalicílico'),
  ('2918.22.12', '<i>o</i>-Acetilsalicilato de alumínio'),
  ('2918.22.19', 'Outros'),
  ('2918.22.20', 'Ésteres'),
  ('2918.23.00', '-- Outros ésteres do ácido salicílico e seus sais'),
  ('2918.29.10', 'Ácidos hidroxinaftoicos'),
  ('2918.29.21', 'Ácido <i>p</i>-hidroxibenzoico'),
  ('2918.29.22', 'Metilparabeno'),
  ('2918.29.23', 'Propilparabeno'),
  ('2918.29.29', 'Outros'),
  ('2918.29.30', 'Ácido gálico, seus sais e seus ésteres'),
  ...
  ('2918.30.90', 'Outros'),
  ('2918.91.00', '-- 2,4,5-T (ISO) (ácido 2,4,5-triclorofenoxiacético), seus sais e seus ésteres'),
  ('2918.99.11', 'Ácido fenoxiacético, seus sais e seus ésteres'),
  ...
  ('2918.99.50', 'Ácido 3-(2-cloro-alfa, alfa, alfa-trifluor-<i>p</i>-toliloxi)benzoico'),
  ...
  ('2921.59.32', 'Ácido 4,4''-diaminodifenilamino-2-sulfônico e seus sais'),
  ('2921.59.39', 'Outros'),
  ('2921.59.90', 'Outros'),
  ...
  ('2922.16.00', '-- Perfluoroctanossulfonato de dietanolamônio'),
  ...
  ('2922.19.94', 'Mirtecaína'),
  ('2922.19.95', 'Tamoxifen e seu citrato'),
  ('2922.19.96', 'Propranolol e seus sais'),
  ('2922.19.99', 'Outros'),
  ('2922.21.00', '-- Ácidos aminohidroxinaftalenossulfônicos e seus sais'),
...
INSERT INTO public.ncm (codigo, descricao) VALUES
  ...
  ('2922.42.20', 'Sais'),
  ('2922.43.00', '-- Ácido antranílico e seus sais'),
  ('2922.44.10', 'Tilidina'),
  ('2922.44.20', 'Sais'),
  ('2922.49.10', 'Glicina e seus sais'),
  ('2922.49.20', 'Ácido etilenodiaminotetracético (EDTA) e seus sais'),
  ('2922.49.31', 'Ácido iminodiacético'),
  ('2922.49.32', 'Sais'),
  ('2922.49.40', 'Ácido dietilenotriaminopentacético e seus sais'),
  ('2922.49.51', 'alfa-Fenilglicina'),
  ('2922.49.52', 'Cloridrato de cloreto de D(-)alfa-aminobenzenoacetila'),
  ('2922.49.59', 'Outros'),
  ('2922.49.61', 'Diclofenaco de sódio'),
  ('2922.49.62', 'Diclofenaco de potássio'),
  ('2922.49.63', 'Diclofenaco de dietilamônio'),
  ...
  ('2922.50.39', 'Outros'),
  ('2922.50.91', 'N-(1-(Metoxicarbonil)propen-2-il)-alfa-amino-<i>p</i>-hidroxifenilacetato de sódio (NAPOH)'),
  ('2922.50.99', 'Outros'),
  ('2923.10.00', '- Colina e seus sais'),
  ('2923.20.00', '- Lecitinas e outros fosfoaminolipídios'),
  ('2923.30.00', '- Perfluoroctanossulfonato de tetraetilamônio'),
  ('2923.40.00', '- Perfluoroctanossulfonato de didecildimetilamônio'),
  ('2923.90.10', 'Betaína e seus sais'),
  ('2923.90.20', 'Derivados da colina'),
  ('2923.90.30', 'Cloreto de 3-cloro-2-hidroxipropiltrimetilamônio'),
  ('2923.90.40', 'Halogenetos de alquil-trimetilamônio, com grupo alquila de C<sub>6</sub> a C<sub>22</sub>'),
  ('2923.90.50', 'Halogenetos de dialquil-dimetilamônio ou de alquil-benzil-dimetilamônio, com grupo alquila de C<sub>6</sub> a C<sub>22</sub>'),
  ('2923.90.60', 'Halogenetos de pentametil-alquil-propilenodiamônio, com grupo alquila de C<sub>6</sub> a C<sub>22</sub>'),
  ('2923.90.90', 'Outros'),
  ('2924.11.00', '-- Meprobamato (DCI)'),
  ('2924.12.10', 'Fluoracetamida'),
  ('2924.12.20', 'Fosfamidona'),
  ('2924.12.30', 'Monocrotofós'),
  ...
  ('2924.19.39', 'Outros'),
  ('2924.19.42', 'Dicrotofós'),
  ('2924.19.49', 'Outros'),
  ('2924.19.91', 'N,N''-Dimetilureia'),
  ('2924.19.92', 'Carisoprodol'),
  ('2924.19.93', 'N,N''-(Diestearoil)etilenodiamina (N,N''-etilen-bis-estearamida)'),
  ('2924.19.94', 'Dietanolamidas de ácidos graxos (gordos) de C<sub>12</sub> a C<sub>18</sub>'),
  ('2924.19.99', 'Outros'),
  ('2924.21.11', 'Hexanitrocarbanilidas'),
  ('2924.21.19', 'Outros'),
  ('2924.21.20', 'Diuron'),
  ('2924.21.90', 'Outros'),
  ('2924.23.00', '-- Ácido 2-acetamidobenzoico (ácido N-acetilantranílico) e seus sais'),
  ...
  ('2924.29.19', 'Outros'),
  ('2924.29.20', 'Anilidas dos ácidos hidroxinaftoicos e seus derivados; sais destes produtos'),
  ('2924.29.31', 'Carbaril'),
  ('2924.29.32', 'Propoxur'),
  ('2924.29.39', 'Outros'),
  ('2924.29.41', 'Teclozam'),
  ...
  ('2924.29.45', 'Iodamida'),
  ('2924.29.46', 'Cloreto do ácido <i>p</i>-acetamidobenzenossulfônico'),
  ('2924.29.47', 'Ácido ioxitalâmico'),
  ('2924.29.49', 'Outros'),
  ...
  ('2924.29.63', 'Prilocaína e seu cloridrato'),
  ...
  ('2929.90.50', 'Fosfonamidofluoridatos de N-(1-(dialquila (de até C<sub>10</sub>, incluindo cicloalquila)amino))alquilideno (H ou de até C<sub>10</sub>, incluindo cicloalquila) e sais alquilados ou protonados destes produtos'),
  ('2929.90.60', 'Fosforamidofluoridatos de O-alquila (H ou de até C<sub>10</sub>, incluindo cicloalquila) N-(1-(dialquila (de até C<sub>10</sub>, incluindo  cicloalquila)amino))alquilideno (H ou de até C<sub>10</sub>, incluindo cicloalquila) e sais alquilados ou protonados destes produtos'),
  ('2929.90.90', 'Outros'),
  ...
  ('2930.90.96', 'Hidrogênio alquil(de C<sub>1</sub> a C<sub>3</sub>)fosfonotioatos de [S-2-(dialquil(de C<sub>1</sub> a C<sub>3</sub>)amino)etila], seus ésteres de O-alquila (de até C<sub>10</sub>, incluindo os cicloalquila); sais alquilados ou protonados destes produtos'),
  ('2930.90.97', 'Outros compostos que contenham um átomo de fósforo ligado a um grupo alquila (de C<sub>1</sub> a C<sub>3</sub>) mas sem outros átomos de carbono'),
...
INSERT INTO public.ncm (codigo, descricao) VALUES
  ...
  ('2931.49.20', 'Hidrogênio alquil(de C<sub>1</sub> a C<sub>3</sub>)fosfonitos de [O-2-(dialquil(de C<sub>1</sub> a C<sub>3</sub>)amino)etila], seus ésteres de O-alquila (de até C<sub>10</sub>, incluindo os cicloalquila); sais alquilados ou protonados destes produtos'),
  ('2931.49.31', 'Metilfosfinato de butila'),
  ('2931.49.32', 'Metilfosfonato de bis(1-metilpentila)'),
  ('2931.49.39', 'Outros'),
  ('2931.49.40', 'N,N-Dialquil(de C<sub>1</sub> a C<sub>3</sub>)fosforoamidocianidatos de O-alquila (de até C<sub>10</sub>, incluindo os cicloalquila)'),
  ('2931.49.90', 'Outros'),
  ...
  ('2931.59.91', 'Alquil(de C<sub>1</sub> a C<sub>3</sub>)fosfonofluoridatos de O-alquila (de até C<sub>10</sub>, incluindo os cicloalquila)'),
  ...
  ('2931.59.95', 'Fosfonamidofluoridatos de P-alquila (de até C<sub>10</sub>, incluindo cicloalquila) N-(1-(dialquila (de até C<sub>10</sub>, incluindo cicloalquila)amino))alquilideno (H ou de até C<sub>10</sub>, incluindo cicloalquila) e sais alquilados ou protonados destes produtos'),
  ('2931.59.96', '(Bis(dietilamina)metileno)fosfonamidofluoridato de metila'),
  ('2931.59.98', 'Outros compostos que contenham um átomo de fósforo ligado a um grupo alquila (de C<sub>1</sub> a C<sub>3</sub>) mas sem outros átomos de carbono'),
  ('2931.59.99', 'Outros'),
  ...
  ('2933.39.13', 'Ácido niflúmico'),
  ('2933.39.14', 'Haloxifop (ácido (RS)-2-(4-(3-cloro-5-trifluorometil-2-piridiloxi)fenoxi)propiônico)'),
  ...
  ('2933.39.36', 'Dibrometo de 1-[N,N-dialquila (de até C<sub>10</sub>) -N-(n-hidroxialquil (de até C<sub>10</sub>))amônio]-n-[N-(3-dimetilcarbamoxi-alfa-picolinil)-N,N-dialquil (de até C<sub>10</sub>) amônio]decano (n=1-8)'),
  ('2933.39.37', 'Benzilato de 3-quinuclidinila'),
  ('2933.39.39', 'Outros'),
  ('2933.39.41', 'Dibrometo de 1-[N,N-dialquila (de até C<sub>10</sub>) -N-(n-(ciano, acetoxi)alquil (de até C<sub>10</sub>))amônio]-n-[N-(3-dimetilcarbamoxi-alfa-picolinil)-N,N-dialquil (de até C<sub>10</sub>) amônio]decano (n=1-8)'),
  ('2933.39.42', 'Dibrometo de 1,n-bis[N-(3-dimetilcarbamoxi-alfa-picolil)-N,N-dialquila (de até C<sub>10</sub>) amônio]-alcano-(2,(n-1)-diona) (n=2-12)'),
...
INSERT INTO public.ncm (codigo, descricao) VALUES
  ...
  ('2933.91.89', 'Outros'),
  ('2933.92.00', '-- Azinfós metil (ISO)'),
  ('2933.99.11', 'Pirazinamida'),
  ('2933.99.12', 'Cloridrato de amilorida'),
  ('2933.99.13', 'Pindolol'),
  ('2933.99.19', 'Outros'),
  ('2933.99.20', 'Cuja estrutura contém um ciclo diazepina (hidrogenado ou não)'),
  ...
  ('2933.99.53', 'Albendazol e seu sulfóxido'),
  ...
  ('2933.99.63', 'Triazofós (fosforotioato de O,O-dietila O-(1-fenil-1H-1,2,4-triazol-3-ila))'),
  ('2933.99.69', 'Outros'),
  ('2933.99.91', 'Azinfós etílico'),
  ('2933.99.92', 'Ácido nalidíxico'),
  ('2933.99.93', 'Clofazimina'),
  ('2933.99.95', 'Metilssulfato de amezínio'),
  ...
  ('2935.90.15', 'Sulfametazina (4,6-dimetil-2-sulfanilamidopirimidina) e seu sal sódico'),
  ('2935.90.19', 'Outras'),
  ...
  ('2935.90.99', 'Outras'),
  ('2936.21.11', 'Vitamina A<sub>1</sub> álcool (retinol)'),
  ('2936.21.12', 'Acetato'),
  ...
  ('2936.23.20', '5''-Fosfato sódico de vitamina B<sub>2</sub> (5''-fosfato sódico de riboflavina)'),
  ('2936.23.90', 'Outros'),
  ...
  ('2936.28.19', 'Outros'),
  ('2936.28.90', 'Outros'),
  ('2936.29.11', 'Vitamina B<sub>9</sub> (ácido fólico) e seus sais'),
  ('2936.29.19', 'Outros'),
  ...
  ('2937.29.90', 'Outros'),
  ('2937.50.00', '- Prostaglandinas, tromboxanas e leucotrienos, seus derivados e análogos estruturais'),
  ('2937.90.10', 'Tiratricol (triac) e seu sal sódico'),
  ('2937.90.30', 'Levotiroxina sódica'),
  ('2937.90.40', 'Liotironina sódica'),
  ('2937.90.90', 'Outros')
ON CONFLICT (codigo) DO NOTHING;

INSERT INTO public.ncm (codigo, descricao) VALUES
  ('2938.10.00', '- Rutosídio (rutina) e seus derivados'),
  ('2938.90.10', 'Deslanosídio'),
  ('2938.90.20', 'Esteviosídio'),
  ('2938.90.90', 'Outros'),
  ...
  ('2940.00.13', 'Ramnose'),
  ('2940.00.19', 'Outros'),
  ('2940.00.21', 'Ácido lactobiônico'),
  ('2940.00.22', 'Lactobionato de cálcio'),
  ('2940.00.23', 'Bromolactobionato de cálcio'),
  ('2940.00.29', 'Outros'),
  ('2940.00.92', 'Frutose-1,6-difosfato de cálcio ou de sódio'),
  ('2940.00.93', 'Maltitol'),
  ...
  ('2941.10.39', 'Outros'),
  ('2941.10.41', 'Penicilina G potássica'),
  ('2941.10.42', 'Penicilina G benzatínica'),
  ('2941.10.43', 'Penicilina G procaínica'),
  ('2941.10.49', 'Outros'),
  ('2941.10.90', 'Outros'),
  ('2941.20.10', 'Sulfatos'),
  ('2941.20.90', 'Outros'),
  ...
  ('2941.90.33', 'Cefaclor e cefalexina monoidratados, cefalotina sódica'),
  ...
  ('3002.42.70', 'Contra as seguintes enfermidades: de <i>Newcastle</i>, a vírus vivo ou vírus inativo; de Gumboro, a vírus vivo ou vírus inativo; bronquite, a vírus vivo ou vírus inativo; difteroviruela, a vírus vivo; síndrome de queda de postura (EDS); salmonelose aviária, elaborada com cepa 9R; cólera de aves, inativadas'),
...
INSERT INTO public.ncm (codigo, descricao) VALUES
  ...
  ('3003.39.91', 'Sal sódico ou éster metílico do ácido 9,11,15-triidroxi-16-(3-clorofenoxi)prosta-5,13-dien-1-oico (derivado da prostaglandina F<sub>2</sub>-alfa)'),
  ...
  ('3003.90.14', 'Vitamina A<sub>1</sub> (retinol) ou seus derivados, exceto o ácido retinoico (tretinoína)'),
  ('3003.90.15', 'D-Pantotenato de cálcio; vitamina D<sub>3</sub> (colecalciferol)'),
  ('3003.90.16', 'Ésteres das vitaminas A e D<sub>3</sub>, em concentração igual ou superior a 1.500.000 UI/g de vitamina A e igual ou superior a 50.000 UI/g de vitamina D<sub>3</sub>'),
  ...
  ('3003.90.34', 'Ácido <i>o</i>-acetilsalicílico; <i>o</i>-acetilsalicilato de alumínio; salicilato de metila; diclorvós'),
  ...
  ('3003.90.88', 'Amprenavir; aprepitanto; delavirdina ou seu mesilato; efavirenz; emtricitabina; etopósido; everolimus; fosamprenavir cálcico; fosfato de fludarabina; gencitabina ou seu cloridrato; mesilato de dabrafenibe; raltitrexida; ritonavir; sirolimus; tacrolimus; temsirolimus; tenipósido; tipranavir'),
  ('3003.90.89', 'Outros'),
  ...
  ('3004.39.91', 'Sal sódico ou éster metílico do ácido 9,11,15-triidroxi-16-(3-clorofenoxi)prosta-5,13-dien-1-oico (derivado da prostaglandina F<sub>2</sub>-alfa)'),
  ...
  ('3004.50.40', 'Vitamina A<sub>1</sub> (retinol) ou seus derivados, exceto o ácido retinoico (tretinoína)'),
  ('3004.50.50', 'D-Pantotenato de cálcio; vitamina D<sub>3</sub> (colecalciferol)'),
  ...
  ('3004.90.24', 'Ácido <i>o</i>-acetilsalicílico; <i>o</i>-acetilsalicilato de alumínio; salicilato de metila; diclorvós'),
  ...
  ('3004.90.78', 'Amprenavir; aprepitanto; delavirdina ou seu mesilato; efavirenz; emtricitabina; etopósido; everolimus; fosamprenavir cálcico; fosfato de fludarabina; gencitabina ou seu cloridrato; mesilato de dabrafenibe; raltitrexida; ritonavir; sirolimus; tacrolimus; temsirolimus; tenipósido; tipranavir'),
  ('3004.90.79', 'Outros')
ON CONFLICT (codigo) DO NOTHING;
...
INSERT INTO public.ncm (codigo, descricao) VALUES
  ...
  ('3103.11.00', '-- Que contenham, em peso, 35 % ou mais de pentóxido de difósforo (P<sub>2</sub>O<sub>5</sub>)'),
  ('3103.19.00', '-- Outros'),
  ('3103.90.11', 'Que contenha, em peso, 46 % ou menos de pentóxido de difósforo (P<sub>2</sub>O<sub>5</sub>)'),
  ('3103.90.19', 'Outros'),
  ('3103.90.90', 'Outros'),
  ('3104.20.10', 'Que contenha, em peso, 60 % ou menos de óxido de potássio (K<sub>2</sub>O)'),
  ('3104.20.90', 'Outros'),
  ('3104.30.10', 'Que contenha, em peso, 52 % ou menos de óxido de potássio (K<sub>2</sub>O)'),
  ('3104.30.90', 'Outros'),
  ('3104.90.10', 'Sulfato duplo de potássio e magnésio, que contenha, em peso, 30 % ou mais de óxido de potássio (K<sub>2</sub>O)'),
  ('3104.90.90', 'Outros'),
  ...
  ('3105.90.11', 'Que contenha, em peso, 15 % ou menos de nitrogênio (azoto) e 15 % ou menos de óxido de potássio (K<sub>2</sub>O)'),
  ('3105.90.19', 'Outros'),
  ('3105.90.90', 'Outros'),
  ...
  ('3206.50.29', 'Outros'),
  ('3207.10.20', 'Suspensão de pigmentos em solventes orgânicos, do tipo utilizado em impressoras de jato de tinta para decoração de superfícies cerâmicas por cozimento'),
  ('3207.10.30', 'Outros, à base de zircônio ou de seus sais'),
  ('3207.10.90', 'Outros'),
  ('3207.20.10', 'Engobos'),
...
INSERT INTO public.ncm (codigo, descricao) VALUES
  ...
  ('3404.90.14', 'De dímero de alquilceteno com dois grupos alternados <i>n</i>-alquila de C<sub>12</sub>, C<sub>14</sub> e C<sub>16</sub>, em grânulos'),
  ('3404.90.19', 'Outras'),
  ...
  ('3606.10.00', '- Combustíveis líquidos e combustíveis gasosos liquefeitos, em recipientes do tipo utilizado para carregar ou recarregar isqueiros ou acendedores, com capacidade não superior a 300 cm<sup>3</sup>'),
  ('3606.90.00', '- Outros'),
  ...
  ('3705.00.10', 'Fotomáscaras sobre vidro plano, positivas, próprias para gravação em pastilhas de silício (<i>chips</i>) para fabricação de microestruturas eletrônicas'),
  ('3705.00.90', 'Outros'),
  ...
  ('3808.91.91', 'À base de acefato ou de <i>Bacillus thuringiensis</i>'),
...
INSERT INTO public.ncm (codigo, descricao) VALUES
  ...
  ('3812.31.00', '-- Misturas de oligômeros de 2,2,4-trimetil-1,2-di-hidroquinolina (TMQ)'),
  ('3812.39.11', 'Que contenham derivados N-substituídos de <i>p</i>-fenilenodiamina'),
  ('3812.39.12', 'Que contenham fosfitos de alquila, de arila ou de alquil-arila'),
  ('3812.39.19', 'Outros'),
  ('3812.39.21', 'Que contenham derivados N-substituídos de <i>p</i>-fenilenodiamina'),
  ('3812.39.29', 'Outros'),
  ...
  ('3814.00.20', 'Que contenham hidroclorofluorcarbonetos (HCFC) do metano, do etano ou do propano, mas que não contenham clorofluorcarbonetos (CFC)'),
  ('3814.00.30', 'Que contenham tetracloreto de carbono, bromoclorometano ou 1,1,1-tricloroetano (metilclorofórmio)'),
  ('3814.00.90', 'Outros'),
  ...
  ('3822.12.00', '-- Para a zika e outras doenças transmitidas por mosquitos do gênero <i>Aedes</i>'),
  ...
  ('3823.13.00', '-- Ácidos graxos (gordos) do <i>tall oil</i>'),
  ...
  ('3824.99.24', 'Ésteres de álcoois graxos (gordos) de C<sub>12</sub> a C<sub>20 </sub>do ácido metacrílico e suas misturas; ésteres de ácidos monocarboxílicos de C<sub>10</sub> ramificados com glicerol'),
  ('3824.99.25', 'Misturas de ésteres dimetílicos dos ácidos adípico, glutárico e succínico; misturas de ácidos dibásicos de C<sub>11</sub> e C<sub>12</sub>; ácidos naftênicos, seus sais insolúveis em água e seus ésteres'),
  ('3824.99.29', 'Outros'),
  ...
  ('3824.99.74', 'Preparações à base de hidróxido de níquel ou de cádmio, de óxido de cádmio ou de óxido ferroso férrico, próprios para a fabricação de acumuladores alcalinos'),
  ...
  ('3901.90.50', 'Copolímeros de etileno - ácido metacrílico, com um conteúdo de etileno igual ou superior a 60 %, em peso'),
  ('3901.90.90', 'Outros'),
...
INSERT INTO public.ncm (codigo, descricao) VALUES
  ...
  ('3906.90.22', 'Copolímero de metacrilato de 2-di-isopropilaminoetila e metacrilato de <i>n</i>-decila, em suspensão de dimetilacetamida'),
  ('3906.90.29', 'Outros'),
  ...
  ('3907.29.92', 'Éter metalílico de poli(oxietileno) (HPEG)'),
  ('3907.29.99', 'Outros'),
  ...
  ('3910.00.13', 'Copolímeros de dimetilsiloxano com compostos vinílicos, de viscosidade igual ou superior a 1.000.000 cSt'),
  ('3910.00.19', 'Outros'),
  ...
  ('3920.10.91', 'De densidade inferior a 0,94, com óleo de parafina e carga (sílica e negro de fumo), apresentando nervuras paralelas entre si, com uma resistência elétrica igual ou superior a 0,030 ohms.cm<sup>2</sup>, mas inferior ou igual a 0,120 ohms.cm<sup>2</sup>, em rolos, do tipo utilizado para a fabricação de separadores de acumuladores elétricos'),
  ('3920.10.99', 'Outras'),
  ...
  ('3921.13.10', 'Com base poliéster, de células abertas, com um número de poros por decímetro linear igual ou superior a 24 e inferior ou igual a 157 (6 a 40 poros por polegada linear), com resistência à compressão 50 % (RC<sub>50</sub>) igual ou superior a 3,0 kPa e inferior ou igual a 6,0 kPa'),
  ('3921.13.90', 'Outras'),
  ...
  ('3923.10.90', 'Outros'),
  ('3923.21.10', 'De capacidade inferior ou igual a 1.000 cm<sup>3</sup>'),
  ('3923.21.90', 'Outros'),
  ('3923.29.10', 'De capacidade inferior ou igual a 1.000 cm<sup>3</sup>'),
  ('3923.29.90', 'Outros'),
...
INSERT INTO public.ncm (codigo, descricao) VALUES
  ...
  ('3926.90.50', 'Acessórios do tipo utilizado em linhas de sangue para hemodiálise, tais como: obturadores, incluindo os reguláveis (clamps), clipes e semelhantes'),
  ('3926.90.61', 'De tetrafluoretileno e éter perfluorometilvinil'),
  ('3926.90.69', 'Outros'),
  ('3926.90.90', 'Outras'),
  ...
  ('4002.19.12', 'Grau alimentício de acordo com o estabelecido pelo <i>Food Chemical Codex</i>, em formas primárias'),
  ('4002.19.19', 'Outras'),
  ('4002.19.20', 'De estireno-butadieno carboxilada (XSBR)'),
  ('4002.20.10', 'Óleo'),
  ('4002.20.91', '1,2-polibutadieno sindiotáctico'),
  ('4002.20.99', 'Outras'),
  ...
  ('4002.70.00', '- Borracha de etileno-propileno-dieno não conjugado (EPDM)'),
  ...
  ('4009.12.10', 'Com uma pressão de ruptura igual ou superior a 17,3 MPa'),
  ('4009.12.90', 'Outros'),
  ...
  ('4010.39.00', '-- Outras'),
  ('4011.10.00', '- Do tipo utilizado em automóveis de passageiros (incluindo os veículos de uso misto (<i>station wagons</i>) e os automóveis de corrida)'),
  ...
  ('4011.70.90', 'Outros'),
  ('4011.80.10', 'Radiais, para <i>dumpers</i> concebidos para serem utilizados fora de rodovias, com seção de largura igual ou superior a 940 mm (37"), para aros de diâmetro igual ou superior a 1.448 mm (57")'),
  ...
  ('4011.90.90', 'Outros'),
  ('4012.11.00', '-- Do tipo utilizado em automóveis de passageiros (incluindo os veículos de uso misto (<i>station wagons</i>) e os automóveis de corrida)'),
  ...
  ('4016.95.90', 'Outros'),
  ('4016.99.10', 'Tampões vedadores para condensadores, de EPDM, com perfurações para terminais'),
  ('4016.99.90', 'Outras'),
  ('4017.00.00', 'Borracha endurecida (ebonite, por exemplo) sob qualquer forma, incluindo os desperdícios e resíduos; obras de borracha endurecida.'),
  ('4101.20.00', '- Couros e peles em bruto, inteiros, não divididos, de peso unitário não superior a 8 kg quando secos, a 10 kg quando salgados a seco e a 16 kg quando frescos, salgados a úmido ou conservados de outro modo'),
  ...
  ('4103.90.00', '- Outros'),
  ('4104.11.11', 'Couros e peles inteiros, de bovinos (incluindo os búfalos), de superfície unitária não superior a 2,6 m<sup>2</sup>, simplesmente curtidos ao cromo (<i>wet-blue</i>)'),
  ('4104.11.12', 'Outros couros e peles inteiros, de bovinos (incluindo os búfalos), de superfície unitária não superior a 2,6 m<sup>2</sup>'),
  ('4104.11.13', 'Outros couros e peles de bovinos (incluindo os búfalos), com pré-curtimenta vegetal'),
  ('4104.11.14', 'Outros couros e peles de bovinos (incluindo os búfalos)'),
  ('4104.11.19', 'Outros'),
  ('4104.11.21', 'Couros e peles inteiros, de bovinos (incluindo os búfalos), de superfície unitária não superior a 2,6 m<sup>2</sup>, simplesmente curtidos ao cromo (<i>wet-blue</i>)'),
  ('4104.11.22', 'Outros couros e peles inteiros, de bovinos (incluindo os búfalos), de superfície unitária não superior a 2,6 m<sup>2</sup>'),
  ('4104.11.23', 'Outros couros e peles de bovinos (incluindo os búfalos), com pré-curtimenta vegetal'),
  ('4104.11.24', 'Outros couros e peles de bovinos (incluindo os búfalos)'),
  ('4104.11.29', 'Outros'),
  ('4104.19.10', 'Couros e peles inteiros, de bovinos (incluindo os búfalos), de superfície unitária não superior a 2,6 m<sup>2</sup>, simplesmente curtidos ao cromo (<i>wet-blue</i>)'),
  ('4104.19.20', 'Outros couros e peles inteiros, de bovinos (incluindo os búfalos), de superfície unitária não superior a 2,6 m<sup>2</sup>'),
  ('4104.19.30', 'Outros couros e peles de bovinos (incluindo os búfalos), com pré-curtimenta vegetal'),
  ('4104.19.40', 'Outros couros e peles de bovinos (incluindo os búfalos)'),
  ('4104.19.90', 'Outros'),
  ('4104.41.10', 'Couros e peles inteiros, de bovinos (incluindo os búfalos), de superfície unitária não superior a 2,6 m<sup>2</sup>'),
  ('4104.41.20', 'Outros couros e peles de bovinos (incluindo os búfalos), curtidos ao vegetal, para solas'),
  ('4104.41.30', 'Outros couros e peles de bovinos (incluindo os búfalos)'),
  ('4104.41.90', 'Outros'),
  ('4104.49.10', 'Couros e peles inteiros, de bovinos (incluindo os búfalos), de superfície unitária não superior a 2,6 m<sup>2 </sup>'),
  ...
  ('4106.91.00', '-- No estado úmido (incluindo <i>wet-blue</i>)'),
  ('4106.92.00', '-- No estado seco (<i>crust</i>)'),
  ('4107.11.10', 'Couros e peles de bovinos (incluindo os búfalos), de superfície unitária não superior a 2,6 m<sup>2</sup>'),
  ('4107.11.20', 'Outros couros e peles de bovinos (incluindo os búfalos)'),
  ('4107.11.90', 'Outros'),
  ('4107.12.10', 'Couros e peles de bovinos (incluindo os búfalos), de superfície unitária não superior a 2,6 m<sup>2</sup>'),
  ('4107.12.20', 'Outros couros e peles de bovinos (incluindo os búfalos)'),
  ('4107.12.90', 'Outros'),
  ('4107.19.10', 'Couros e peles de bovinos (incluindo os búfalos), de superfície unitária não superior a 2,6 m<sup>2</sup>'),
  ('4107.19.20', 'Outros couros e peles de bovinos (incluindo os búfalos)'),
  ('4107.19.90', 'Outros'),
  ('4107.91.10', 'De bovinos (incluindo os búfalos)'),
  ('4107.91.90', 'Outros'),
  ('4107.92.10', 'De bovinos (incluindo os búfalos)'),
  ('4107.92.90', 'Outros'),
  ('4107.99.10', 'De bovinos (incluindo os búfalos)'),
  ('4107.99.90', 'Outros'),
  ('4112.00.00', 'Couros preparados após curtimenta ou após secagem (<i>crusting</i>) e couros e peles apergaminhados, de ovinos, depilados, mesmo divididos, exceto os da posição 41.14.'),
  ...
  ('4206.00.00', 'Obras de tripa, de <i>baudruches</i>, de bexiga ou de tendões.'),
  ('4301.10.00', '- De visons, inteiras, mesmo com cabeça, cauda ou patas'),
  ('4301.30.00', '- De cordeiros denominados astracã, <i>breitschwanz</i>, caracul, <i>persianer</i> ou semelhantes, de cordeiros da Índia, da China, da Mongólia ou do Tibete, inteiras, mesmo com cabeça, cauda ou patas'),
  ...
  ('4401.11.00', '-- De coníferas'),
  ('4401.12.00', '-- De não coníferas'),
...
INSERT INTO public.ncm (codigo, descricao) VALUES
  ...
  ('4401.49.00', '-- Outros'),
  ('4402.10.00', '- De bambu'),
  ('4402.20.00', '- De cascas ou de caroços'),
  ('4402.90.00', '- Outros'),
  ('4403.11.00', '-- De coníferas'),
  ('4403.12.00', '-- De não coníferas'),
  ('4403.21.00', '-- De pinheiro (<i>Pinus</i> spp.), cuja menor dimensão da seção transversal é igual ou superior a 15 cm'),
  ('4403.22.00', '-- De pinheiro (<i>Pinus</i> spp.), outras'),
  ('4403.23.00', '-- De abeto (<i>Abies</i> spp.) e de espruce (pícea) (<i>Picea</i> spp.), cuja menor dimensão da seção transversal é igual ou superior a 15 cm'),
  ('4403.24.00', '-- De abeto (<i>Abies</i> spp.) e de espruce (pícea) (<i>Picea</i> spp.), outras'),
  ('4403.25.00', '-- Outras, cuja menor dimensão da seção transversal é igual ou superior a 15 cm'),
  ('4403.26.00', '-- Outras'),
  ('4403.41.00', '-- Dark Red Meranti, Light Red Meranti e Meranti Bakau'),
  ('4403.42.00', '-- Teca'),
  ('4403.49.00', '-- Outras'),
  ('4403.91.00', '-- De carvalho (<i>Quercus</i> spp.)'),
  ('4403.93.00', '-- De faia (<i>Fagus</i> spp.), cuja menor dimensão da seção transversal é igual ou superior a 15 cm'),
  ('4403.94.00', '-- De faia (<i>Fagus</i> spp.), outras'),
  ('4403.95.00', '-- De bétula (vidoeiro) (<i>Betula</i> spp.), cuja menor dimensão da seção transversal é igual ou superior a 15 cm'),
  ('4403.96.00', '-- De bétula (vidoeiro) (<i>Betula</i> spp.), outras'),
  ('4403.97.00', '-- De choupo (álamo) (<i>Populus</i> spp.)'),
  ...
  ('4406.11.00', '-- De coníferas'),
  ('4406.12.00', '-- De não coníferas'),
  ('4406.91.00', '-- De coníferas'),
  ('4406.92.00', '-- De não coníferas'),
  ('4407.11.00', '-- De pinheiro (<i>Pinus</i> spp.)'),
  ('4407.12.00', '-- De abeto (<i>Abies</i> spp.) e de espruce (pícea) (<i>Picea</i> spp.)'),
  ('4407.13.00', '-- De S-P-F (espruce (pícea) (<i>Picea</i> spp.), pinheiro (<i>Pinus</i> spp.) e abeto (<i>Abies</i> spp.))'),
  ...
  ('4407.29.40', 'De louro'),
  ('4407.29.50', 'De canafístula (<i>Peltophorum vogelianum</i>)'),
  ('4407.29.60', 'De cabreúva Parda (<i>Myrocarpus</i> spp.)'),
  ('4407.29.70', 'De urundei (<i>Astronium balansae</i>)'),
  ('4407.29.90', 'Outras'),
  ('4407.91.00', '-- De carvalho (<i>Quercus</i> spp.)'),
  ('4407.92.00', '-- De faia (<i>Fagus</i> spp.)'),
  ('4407.93.00', '-- De bordo (ácer) (<i>Acer</i> spp.)'),
  ('4407.94.00', '-- De prunóidea (<i>Prunus</i> spp.)'),
  ('4407.95.00', '-- De freixo (<i>Fraxinus</i> spp.)'),
  ('4407.96.00', '-- De bétula (vidoeiro) (<i>Betula</i> spp.)'),
  ('4407.97.00', '-- De choupo (álamo) (<i>Populus</i> spp.)'),
  ...
  ('4410.11.21', 'Em ambas as faces, com película protetora na face superior e trabalho de encaixe nas quatro laterais, do tipo utilizado para pisos (pavimentos)'),
  ('4410.11.29', 'Outros'),
  ('4410.11.90', 'Outros'),
  ...
  ('4411.13.91', 'Recobertos em ambas as faces com papel impregnado de melamina, película protetora na face superior e trabalho de encaixe nas quatro laterais, do tipo utilizado para pisos (pavimentos)'),
  ('4411.13.99', 'Outros'),
  ...
  ('4412.34.00', '-- Outras, com, pelo menos, uma camada exterior de madeira não conífera, não especificadas na subposição 4412.33'),
  ...
  ('4412.99.00', '-- Outras, com ambas as camadas exteriores de madeira de coníferas'),
  ...
  ('4417.00.20', 'Formas, alargadeiras e esticadores, para calçado'),
  ('4417.00.90', 'Outros'),
  ('4418.11.00', '-- De madeira tropical'),
  ('4418.19.00', '-- Outras'),
  ('4418.21.00', '-- De madeira tropical'),
  ('4418.29.00', '-- Outras'),
  ('4418.30.00', '- Postes e vigas, exceto os produtos das subposições 4418.81 a 4418.89'),
  ('4418.40.00', '- Cofragens para concreto (betão)'),
  ...
  ('4418.89.00', '-- Outros'),
  ('4418.91.00', '-- De bambu'),
  ('4418.92.00', '-- Painéis celulares de madeira'),
  ('4418.99.00', '-- Outras'),
  ('4419.11.00', '-- Tábuas para cortar pão, outras tábuas para cortar e artigos semelhantes'),
  ...
  ('4706.20.00', '- Pastas de fibras obtidas a partir de papel ou cartão reciclados (desperdícios e resíduos)'),
  ...
  ('4707.10.00', '- Papel ou cartão, <i>Kraft</i>, crus, ou papel ou cartão, ondulados (canelados*)'),
  ...
  ('4801.00.30', 'Outros, de peso inferior ou igual a 57 g/m<sup>2</sup>, em que 65 % ou mais, em peso, do conteúdo total de fibras seja constituído por fibras de madeiras obtidas por processo mecânico'),
  ('4801.00.90', 'Outros'),
  ...
  ('4802.54.91', 'Fabricado principalmente a partir de pasta branqueada ou pasta obtida por um processo mecânico, de peso inferior a 19 g/m<sup>2</sup>'),
  ('4802.54.99', 'Outros'),
  ...
  ('4802.61.91', 'De peso inferior ou igual a 57 g/m<sup>2</sup>, em que 65 % ou mais, em peso, do conteúdo total de fibras seja constituído por fibras de madeira obtidas por processo mecânico'),
  ('4802.61.92', '<i>Kraft</i>'),
  ('4802.61.99', 'Outros'),
  ('4802.62.10', 'Em que nenhum lado exceda 360 mm, quando não dobradas'),
  ('4802.62.91', 'De peso inferior ou igual a 57 g/m<sup>2</sup>, em que 65 % ou mais, em peso, do conteúdo total de fibras seja constituído por fibras de madeira obtidas por processo mecânico'),
  ...
  ('4802.69.91', 'De peso inferior ou igual a 57 g/m<sup>2</sup>, em que 65 % ou mais, em peso, do conteúdo total de fibras seja constituído por fibras de madeira obtidas por processo mecânico'),
...
INSERT INTO public.ncm (codigo, descricao) VALUES
  ...
  ('4805.19.00', '-- Outros'),
  ('4805.24.00', '-- De peso não superior a 150 g/m<sup>2</sup>'),
  ('4805.25.00', '-- De peso superior a 150 g/m<sup>2</sup>'),
  ('4805.30.00', '- Papel sulfite de embalagem'),
  ('4805.40.10', 'De peso superior a 15 g/m<sup>2</sup>, mas não superior a 25 g/m<sup>2</sup>, com um conteúdo de fibras sintéticas termossoldáveis igual ou superior a 20 %, mas não superior a 30 %, em peso, do conteúdo total de fibras'),
  ('4805.40.90', 'Outros'),
  ('4805.50.00', '- Papel-feltro e cartão-feltro, papel e cartão lanosos'),
  ('4805.91.00', '-- De peso não superior a 150 g/m<sup>2</sup>'),
  ('4805.92.10', 'Com fibras de vidro'),
  ('4805.92.90', 'Outros'),
  ('4805.93.00', '-- De peso igual ou superior a 225 g/m<sup>2</sup>'),
  ...
  ('4810.13.89', 'Outros'),
  ('4810.13.91', 'Papel revestido ou recoberto em uma face, do tipo <i>wet strength</i>, resistente à umidade e ao meio alcalino'),
  ('4810.13.99', 'Outros'),
  ...
  ('4810.19.89', 'Outros'),
  ('4810.19.91', 'Papel revestido ou recoberto em uma face, do tipo <i>wet strength</i>, resistente à umidade e ao meio alcalino'),
  ('4810.19.99', 'Outros'),
  ...
  ('4811.60.90', 'Outros'),
  ('4811.90.11', 'Recobertos de pasta eletrolítica à base de amido modificado, de peso igual ou superior a 75 g/m<sup>2</sup>, mas não superior a 120 g/m<sup>2</sup>'),
  ('4811.90.19', 'Outros'),
  ('4811.90.20', 'Outros, impregnados e revestidos em ambas as faces com látex numa proporção total, em peso, igual ou superior a 15 %, de peso igual ou superior a 105 g/m<sup>2</sup>, mas não superior a 135 g/m<sup>2</sup>, do tipo utilizado como suporte para fabricação de abrasivos (lixas), em rolos'),
  ('4811.90.90', 'Outros'),
  ...
  ('4822.90.00', '- Outros'),
  ('4823.20.10', 'De peso superior a 15 g/m<sup>2</sup>, mas não superior a 25 g/m<sup>2</sup>, com um conteúdo de fibras sintéticas termossoldáveis igual ou superior a 20 %, mas não superior a 30 %, em peso, do conteúdo total de fibras'),
  ...
  ('4823.90.20', 'De rigidez dielétrica igual ou superior a 600 V (método ASTM D 202 ou equivalente) e de peso inferior ou igual a 60 g/m<sup>2</sup>'),
  ...
  ('4908.90.00', '- Outras'),
  ('4909.00.00', 'Cartões-postais impressos ou ilustrados; cartões impressos com votos ou mensagens pessoais, mesmo ilustrados, mesmo com envelopes, guarnições ou aplicações.'),
  ...
  ('5111.30.10', 'De lã, feltrados, com trama combinada exclusivamente com fibras sintéticas e urdidura exclusivamente de algodão, de peso igual ou superior a 600 g/m<sup>2</sup>, próprios para fabricação de bolas de tênis'),
  ('5111.30.90', 'Outros'),
  ('5111.90.00', '- Outros'),
  ('5112.11.00', '-- De peso não superior a 200 g/m<sup>2</sup>'),
  ('5112.19.10', 'De lã'),
...
INSERT INTO public.ncm (codigo, descricao) VALUES
  ...
  ('5207.90.00', '- Outros'),
  ('5208.11.00', '-- Em ponto de tafetá, de peso não superior a 100 g/m<sup>2</sup>'),
  ('5208.12.00', '-- Em ponto de tafetá, de peso superior a 100 g/m<sup>2</sup>'),
  ('5208.13.00', '-- Em ponto sarjado, incluindo o diagonal, cuja relação de textura não seja superior a 4'),
  ('5208.19.00', '-- Outros tecidos'),
  ('5208.21.00', '-- Em ponto de tafetá, de peso não superior a 100 g/m<sup>2</sup>'),
  ('5208.22.00', '-- Em ponto de tafetá, de peso superior a 100 g/m<sup>2</sup>'),
  ('5208.23.00', '-- Em ponto sarjado, incluindo o diagonal, cuja relação de textura não seja superior a 4'),
  ('5208.29.00', '-- Outros tecidos'),
  ('5208.31.00', '-- Em ponto de tafetá, de peso não superior a 100 g/m<sup>2</sup>'),
  ('5208.32.00', '-- Em ponto de tafetá, de peso superior a 100 g/m<sup>2</sup>'),
  ('5208.33.00', '-- Em ponto sarjado, incluindo o diagonal, cuja relação de textura não seja superior a 4'),
  ('5208.39.00', '-- Outros tecidos'),
  ('5208.41.00', '-- Em ponto de tafetá, de peso não superior a 100 g/m<sup>2</sup>'),
  ('5208.42.00', '-- Em ponto de tafetá, de peso superior a 100 g/m<sup>2</sup>'),
  ('5208.43.00', '-- Em ponto sarjado, incluindo o diagonal, cuja relação de textura não seja superior a 4'),
  ('5208.49.00', '-- Outros tecidos'),
  ('5208.51.00', '-- Em ponto de tafetá, de peso não superior a 100 g/m<sup>2</sup>'),
  ('5208.52.00', '-- Em ponto de tafetá, de peso superior a 100 g/m<sup>2</sup>'),
  ...
  ('5402.19.90', 'Outros'),
  ('5402.20.10', 'De copolímero de ácido <i>p</i>-hidroxibenzoico e ácido hidroxinaftoico'),
  ('5402.20.90', 'Outros'),
  ('5402.31.11', 'Tintos'),
  ('5402.31.19', 'Outros'),
  ('5402.31.90', 'Outros'),
...
INSERT INTO public.ncm (codigo, descricao) VALUES
  ...
  ('5601.30.90', 'Outros'),
  ('5602.10.00', '- Feltros agulhados e artigos obtidos por costura por entrelaçamento (<i>cousus-tricotés</i>)'),
  ...
  ('5605.00.90', 'Outros'),
  ('5606.00.00', 'Fios revestidos por enrolamento, lâminas e formas semelhantes das posições 54.04 ou 54.05, revestidas por enrolamento, exceto os da posição 56.05 e os fios de crina revestidos por enrolamento; fios de froco (<i>chenille</i>); fios denominados "de cadeia" (<i>chaînette</i>).'),
  ...
  ('5702.10.00', '- Tapetes denominados <i>Kelim</i> ou <i>Kilim</i>, <i>Schumacks</i> ou <i>Soumak</i>, <i>Karamanie</i> e tapetes semelhantes tecidos à mão'),
  ...
  ('5704.10.00', '- "Ladrilhos" de área da superfície não superior a 0,3 m<sup>2</sup>'),
  ('5704.20.00', '- "Ladrilhos" de área da superfície superior a 0,3 m<sup>2</sup>, mas não superior a 1 m<sup>2</sup>'),
  ('5704.90.00', '- Outros'),
  ...
  ('5801.22.00', '-- Veludos e pelúcias obtidos por trama, cortados, canelados (<i>côtelés</i>)'),
...
INSERT INTO public.ncm (codigo, descricao) VALUES
  ...
  ('5801.32.00', '-- Veludos e pelúcias obtidos por trama, cortados, canelados (<i>côtelés</i>)'),
  ...
  ('5806.10.00', '- Fitas de veludo, de pelúcias, de tecidos de froco (<i>chenille</i>) ou de tecidos atoalhados (turcos)'),
  ...
  ('5903.90.10', 'De fios de poliéster, impregnados com uma ou mais resinas sintéticas, perceptíveis ou não à vista desarmada, e recobertos com uma ou mais resinas sintéticas perceptíveis à vista desarmada numa de suas faces, do tipo utilizado como suporte para fabricação de abrasivos (lixas), em rolos'),
  ('5903.90.90', 'Outros'),
  ('5904.10.00', '- Linóleos'),
  ('5904.90.00', '- Outros'),
  ...
  ('5911.20.90', 'Outras'),
  ('5911.31.00', '-- De peso inferior a 650 g/m<sup>2</sup>'),
  ('5911.32.00', '-- De peso igual ou superior a 650 g/m<sup>2</sup>'),
...
INSERT INTO public.ncm (codigo, descricao) VALUES
  ...
  ('6404.19.00', '-- Outro'),
  ('6404.20.00', '- Calçado com sola exterior de couro natural ou reconstituído'),
  ...
  ('6405.90.00', '- Outro'),
  ('6406.10.00', '- Partes superiores de calçado e seus componentes, exceto contrafortes e biqueiras rígidas'),
  ('6406.20.00', '- Solas exteriores e saltos, de borracha ou plástico'),
  ('6406.90.10', 'Solas exteriores e saltos, de couro natural ou reconstituído'),
  ...
  ('6505.00.12', 'De fibras sintéticas ou artificiais'),
  ('6505.00.19', 'De outras matérias têxteis'),
  ('6505.00.21', 'De algodão'),
  ('6505.00.22', 'De fibras sintéticas ou artificiais'),
  ('6505.00.29', 'De outras matérias têxteis')
ON CONFLICT (codigo) DO NOTHING;

INSERT INTO public.ncm (codigo, descricao) VALUES
  ('6505.00.31', 'De algodão'),
  ('6505.00.32', 'De fibras sintéticas ou artificiais'),
  ('6505.00.39', 'De outras matérias têxteis'),
  ('6505.00.90', 'Outros'),
  ...
  ('6507.00.00', 'Carneiras, forros, capas, armações, palas e barbicachos (francaletes*), para chapéus e artigos de uso semelhante.'),
  ...
  ('6603.90.00', '- Outros'),
  ('6701.00.00', 'Peles e outras partes de aves, com as suas penas ou penugem, penas, partes de penas, penugem e artigos destas matérias, exceto os produtos da posição 05.05, bem como os cálamos e outros canos de penas, trabalhados.'),
  ('6702.10.00', '- De plástico'),
  ('6702.90.00', '- De outras matérias'),
  ('6703.00.00', 'Cabelo disposto no mesmo sentido, adelgaçado, branqueado ou preparado de outro modo; lã, pelos e outras matérias têxteis, preparados para fabricação de perucas ou de artigos semelhantes.'),
  ('6704.11.00', '-- Perucas completas'),
  ('6704.19.00', '-- Outros'),
  ('6704.20.00', '- De cabelo'),
  ('6704.90.00', '- De outras matérias'),
  ('6801.00.00', 'Pedras para calcetar, meios-fios (lancis) e placas (lajes) para pavimentação, de pedra natural (exceto a ardósia).'),
  ...
  ('6815.91.90', 'Outras'),
  ('6815.99.11', 'Com um teor de alumina (Al<sub>2</sub>O<sub>3</sub>), igual ou superior a 90 %, em peso'),
  ('6815.99.12', 'Com um teor de silica (SiO<sub>2</sub>) igual ou superior a 90 %, em peso'),
  ('6815.99.13', 'Com um teor, em peso, de óxido de zircônio (ZrO<sub>2</sub>) igual ou superior a 50 % mesmo com um conteúdo de alumina inferior a 45 %'),
  ('6815.99.14', 'Constituídas por uma mistura ou combinação de alumina (Al<sub>2</sub>O<sub>3</sub>), silica (SiO<sub>2</sub>) e óxido de zircônio (ZrO<sub>2</sub>), com um teor, em peso, de alumina igual ou superior a 45 %, mas inferior a 90 % ou com um conteúdo, em peso, de óxido de zircônio (ZrO<sub>2</sub>) igual ou superior a 20 %, mas inferior a 50 %'),
  ('6815.99.19', 'Outras'),
  ('6815.99.90', 'Outras'),
  ('6901.00.00', 'Tijolos, placas (lajes), ladrilhos e outras peças cerâmicas de farinhas siliciosas fósseis (por exemplo, <i>kieselguhr</i>, tripolita, diatomita) ou de terras siliciosas semelhantes.'),
  ('6902.10.11', 'Tijolos ou placas, que contenham, em peso, mais de 90 % de trióxido de dicromo'),
  ...
  ('6902.90.20', 'Não fundidos, com um teor de óxido de zircônio (ZrO<sub>2</sub>) superior a 25 %, em peso'),
  ('6902.90.30', 'Com um teor de carbono superior a 85 %, em peso, e diâmetro médio de poro inferior ou igual a 5 micrômetros (mícrons), do tipo utilizado em altos-fornos'),
  ...
  ('6907.23.00', '-- Com um coeficiente de absorção de água, em peso, superior a 10 %'),
  ...
  ('6909.19.30', 'Colmeia de cerâmica à base de alumina (Al<sub>2</sub>O<sub>3</sub>), sílica (SiO<sub>2</sub>) e óxido de magnésio (MgO), de depuradores por conversão catalítica de gases de escape de veículos'),
  ('6909.19.90', 'Outros'),
  ('6909.90.00', '- Outros'),
  ...
  ('7002.32.00', '-- De outro vidro com um coeficiente de dilatação linear não superior a 5 x 10<sup>-</sup><sup>6</sup> por Kelvin, entre 0 °C e 300 °C'),
  ('7002.39.00', '-- Outros'),
  ...
  ('7010.90.90', 'Outros'),
  ('7011.10.10', 'Para lâmpadas ou tubos de descarga, incluindo os de luz relâmpago (<i>flash</i>)'),
  ...
  ('7017.20.00', '- De outro vidro com um coeficiente de dilatação linear não superior a 5 x 10<sup>-</sup><sup>6</sup> por Kelvin, entre 0 °C e 300 °C'),
  ('7017.90.00', '- Outros'),
  ...
  ('7018.90.00', '- Outros'),
  ('7019.11.00', '-- Fios cortados (<i>chopped strands</i>), de comprimento não superior a 50 mm'),
  ...
  ('7019.63.00', '-- Tecidos de fios de malha fechada, em ponto de tafetá, não revestidos nem estratificados'),
  ('7019.64.00', '-- Tecidos de fios de malha fechada, em ponto de tafetá, revestidos ou estratificados'),
  ('7019.65.00', '-- Tecidos de malha aberta de largura não superior a 30 cm'),
  ('7019.66.00', '-- Tecidos de malha aberta de largura superior a 30 cm'),
  ('7019.69.00', '-- Outros'),
  ('7019.71.00', '-- Véus (camadas finas)'),
  ('7019.72.00', '-- Outros tecidos de malha fechada'),
  ('7019.73.10', 'Constituídos por fios paralelizados e superpostos entre si em ângulo de 90°, impregnados e soldados nos pontos de interseção com resina termoplástica, com densidade igual ou superior a 3 e inferior ou igual a 7 fios por centímetro'),
  ('7019.73.90', 'Outros'),
  ('7019.80.00', '- Lã de vidro e suas obras'),
  ('7019.90.00', '- Outras'),
  ('7020.00.10', 'Ampolas de vidro para garrafas térmicas ou para outros recipientes isotérmicos, cujo isolamento seja assegurado pelo vácuo'),
  ('7020.00.90', 'Outras'),
...
INSERT INTO public.ncm (codigo, descricao) VALUES
  ...
  ('7108.11.00', '-- Pós'),
  ('7108.12.10', 'Bulhão dourado (<i>bullion doré</i>)'),
  ('7108.12.90', 'Outras'),
  ...
  ('7204.21.00', '-- De aço inoxidável'),
  ('7204.29.00', '-- Outros'),
  ('7204.30.00', '- Desperdícios e resíduos, e sucata, de ferro ou aço, estanhados'),
  ('7204.41.00', '-- Resíduos do torno e da fresa, aparas, lascas (<i>meulures</i>), pó de serra, limalhas e desperdícios da estampagem ou do corte, mesmo em fardos'),
  ('7204.49.00', '-- Outros'),
  ...
  ('7210.69.11', 'De peso igual ou superior a 120 g/m<sup>2</sup> e com conteúdo de silício igual ou superior a 5 %, mas inferior ou igual a 11 %, em peso'),
  ('7210.69.19', 'Outros'),
  ('7210.69.90', 'Outros'),
...
INSERT INTO public.ncm (codigo, descricao) VALUES
  ...
  ('7306.29.00', '-- Outros'),
  ('7306.30.10', 'De diâmetro exterior igual a 22,25 mm, espessura igual a 2,64 mm e comprimento igual a 448,2 mm'),
  ('7306.30.90', 'Outros'),
  ...
  ('7309.00.90', 'Outros'),
  ('7310.10.10', 'Recipientes isotérmicos refrigerados a nitrogênio (azoto) líquido, do tipo utilizado para sêmen, sangue, tecidos biológicos e outros produtos semelhantes'),
  ('7310.10.90', 'Outros'),
  ...
  ('7314.19.00', '-- Outras'),
  ('7314.20.00', '- Grades e redes, soldadas nos pontos de interseção, de fios com, pelo menos, 3 mm na maior dimensão da seção transversal e com malhas de 100 cm<sup>2</sup> ou mais, de superfície'),
  ...
  ('7410.11.12', 'De espessura inferior ou igual a 0,04 mm e uma resistividade elétrica inferior ou igual a 0,017241 ohm.mm<sup>2</sup>/m'),
...
INSERT INTO public.ncm (codigo, descricao) VALUES
  ...
  ('7501.20.00', '- <i>Sinters</i> de óxidos de níquel e outros produtos intermediários da metalurgia do níquel'),
  ('7502.10.10', 'Catodos'),
  ('7502.10.90', 'Outro'),
  ...
  ('7604.29.19', 'Outras'),
  ('7604.29.20', 'Perfis'),
  ('7605.11.10', 'Com um teor de alumínio igual ou superior a 99,45 %, em peso, e uma resistividade elétrica inferior ou igual a 0,0283 ohm.mm<sup>2</sup>/m'),
  ('7605.11.90', 'Outros'),
  ('7605.19.10', 'Com um teor de alumínio igual ou superior a 99,45 %, em peso, e uma resistividade elétrica inferior ou igual a 0,0283 ohm.mm<sup>2</sup>/m'),
  ('7605.19.90', 'Outros'),
  ('7605.21.10', 'Com um teor, em peso, de alumínio igual ou superior a 98,45 %, e de magnésio e silício, considerados individualmente, igual ou superior a 0,45 % e inferior ou igual a 0,55 % e uma resistividade elétrica inferior ou igual a 0,0328 ohm.mm<sup>2</sup>/m'),
  ('7605.21.90', 'Outros'),
  ('7605.29.10', 'Com um teor, em peso, de alumínio igual ou superior a 98,45 %, e de magnésio e silício, considerados individualmente, igual ou superior a 0,45 % e inferior ou igual a 0,55 % e uma resistividade elétrica inferior ou igual a 0,0328 ohm.mm<sup>2</sup>/m'),
  ('7605.29.90', 'Outros'),
  ...
  ('7612.90.11', 'Para aerossóis, com capacidade inferior ou igual a 700 cm<sup>3</sup>'),
  ...
  ('7612.90.19', 'Outros'),
  ('7612.90.20', 'Recipientes (cápsulas) para embalagem de café e produtos semelhantes, do tipo utilizado em máquinas para preparação de bebidas'),
  ('7612.90.90', 'Outros'),
  ...
  ('7801.99.00', '-- Outro'),
  ('7802.00.00', 'Desperdícios e resíduos, e sucata, de chumbo.'),
  ...
  ('8202.99.10', 'Retas, não dentadas, para serrar pedras'),
  ('8202.99.90', 'Outras'),
  ...
  ('8205.59.00', '-- Outras'),
  ('8205.60.00', '- Lâmpadas ou lamparinas de soldar (maçaricos) e semelhantes'),
  ('8205.70.00', '- Tornos de apertar, sargentos e semelhantes'),
  ('8205.90.00', '- Outros, incluindo os sortidos constituídos por artigos incluídos em pelo menos duas das subposições da presente posição'),
  ...
  ('8207.19.90', 'Outras'),
  ('8207.20.00', '- Fieiras de estiramento ou de extrusão, para metais'),
  ...
  ('8207.50.11', 'Helicoidais, de diâmetro inferior ou igual a 52 mm'),
  ('8207.50.19', 'Outras'),
  ('8207.50.90', 'Outras'),
...
INSERT INTO public.ncm (codigo, descricao) VALUES
  ...
  ('8211.92.10', 'Para cozinha e açougue'),
  ('8211.92.20', 'Para caça'),
  ('8211.92.90', 'Outras'),
  ('8211.93.10', 'Podadeiras e suas partes'),
  ('8211.93.20', 'Canivetes com uma ou várias lâminas ou outras peças'),
  ('8211.93.90', 'Outras'),
  ('8211.94.00', '-- Lâminas'),
  ...
  ('8212.20.10', 'Lâminas'),
  ('8212.20.20', 'Esboços em tiras'),
  ('8212.90.00', '- Outras partes'),
  ('8213.00.00', 'Tesouras e suas lâminas.'),
  ('8214.10.00', '- Espátulas (corta-papéis), abre-cartas, raspadeiras, apontadores de lápis (apara-lápis) e suas lâminas'),
  ...
  ('8304.00.00', 'Classificadores, fichários (ficheiros), caixas de classificação, porta-cópias, porta-canetas, porta-carimbos e artigos semelhantes, de escritório, de metais comuns, excluindo os móveis de escritório da posição 94.03.'),
  ('8305.10.00', '- Ferragens para encadernação de folhas soltas ou para classificadores'),
  ...
  ('8407.31.90', 'Outros'),
  ('8407.32.00', '-- De cilindrada superior a 50 cm<sup>3</sup>, mas não superior a 250 cm<sup>3</sup>'),
  ...
  ('8408.10.90', 'Outros'),
  ('8408.20.10', 'De cilindrada inferior ou igual a 1.500 cm<sup>3</sup>'),
  ('8408.20.20', 'De cilindrada superior a 1.500 cm<sup>3</sup>, mas não superior a 2.500 cm<sup>3</sup>'),
  ('8408.20.30', 'De cilindrada superior a 2.500 cm<sup>3</sup>, mas não superior a 3.500 cm<sup>3</sup>'),
  ('8408.20.90', 'Outros'),
  ...
  ('8409.91.40', 'Sistema de injeção eletrônica'),
  ('8409.91.90', 'Outras'),
  ...
  ('8414.51.20', 'De teto'),
  ('8414.51.90', 'Outros'),
  ('8414.59.10', 'Microventiladores com área de carcaça inferior a 90 cm<sup>2</sup>'),
  ('8414.59.90', 'Outros'),
  ...
  ('8414.80.13', 'De lóbulos paralelos (tipo <i>Roots</i>)'),
  ('8414.80.19', 'Outros'),
  ...
  ('8414.80.33', 'Centrífugos, de vazão máxima inferior a 22.000 m<sup>3</sup>/h'),
...
INSERT INTO public.ncm (codigo, descricao) VALUES
  ('8417.80.90', 'Outros'),
  ('8417.90.00', '- Partes'),
  ('8418.10.00', '- Combinações de refrigeradores e congeladores (<i>freezers</i>), munidos de portas ou gavetas exteriores separadas, ou de uma combinação desses elementos'),
  ('8418.21.00', '-- De compressão'),
  ('8418.29.00', '-- Outros'),
  ('8418.30.00', '- Congeladores (<i>freezers</i>) horizontais (arcas), de capacidade não superior a 800 l'),
  ('8418.40.00', '- Congeladores (<i>freezers</i>) verticais, de capacidade não superior a 900 l'),
  ...
  ('8419.81.90', 'Outros'),
  ('8419.89.11', 'De alimentos, mediante Ultra Alta Temperatura (UHT - <i>Ultra High Temperature</i>) por injeção direta de vapor, com capacidade igual ou superior a 6.500 l/h'),
  ('8419.89.19', 'Outros'),
  ('8419.89.20', 'Estufas'),
  ...
  ('8419.90.31', 'Placa corrugada, de aço inoxidável ou de alumínio, com superfície de troca térmica de área superior a 0,4 m<sup>2</sup>'),
  ('8419.90.39', 'Outras'),
  ...
  ('8421.11.90', 'Outras'),
  ('8421.12.10', 'Com tambor de capacidade inferior ou igual a 23 l'),
  ('8421.12.90', 'Outros'),
  ...
  ('8422.40.10', 'Horizontais, próprias para empacotamento de massas alimentícias longas (comprimento superior a 200 mm) em pacotes tipo almofadas (<i>pillow pack</i>), com capacidade de produção superior a 100 pacotes por minuto e controlador lógico programável (CLP)'),
  ...
  ('8422.90.90', 'Outras'),
  ('8423.10.00', '- Balanças para pessoas, incluindo as balanças para bebês; balanças de uso doméstico'),
  ...
  ('8424.89.20', 'Aparelhos automáticos para projetar lubrificantes sobre pneumáticos, que contenham uma estação de secagem por ar preaquecido e dispositivos para agarrar e movimentar pneumáticos'),
  ('8424.89.90', 'Outros'),
  ...
  ('8429.11.90', 'Outros'),
  ('8429.19.10', '<i>Bulldozers</i> de potência no volante igual ou superior a 234,90 kW (315 HP)'),
  ('8429.19.90', 'Outros'),
  ...
  ('8430.69.11', 'Com capacidade de carga superior a 4 m<sup>3</sup>'),
  ('8430.69.19', 'Outros'),
  ('8430.69.90', 'Outros'),
  ...
  ('8431.42.00', '-- Lâminas para <i>bulldozers</i> ou <i>angledozers</i>'),
...
INSERT INTO public.ncm (codigo, descricao) VALUES
  ...
  ('8439.99.10', 'Rolos, corrugadores ou de pressão, de máquinas para ondular, com largura útil igual ou superior a 2.500 mm'),
  ('8439.99.90', 'Outras'),
  ...
  ('8442.40.90', 'Outras'),
  ('8442.50.00', '- Clichês, placas, cilindros e outros elementos de impressão; pedras litográficas, placas e cilindros, preparados para impressão (por exemplo, aplainados, granulados ou polidos)'),
  ...
  ('8443.31.12', 'De transferência térmica de cera sólida (por exemplo, <i>solid ink</i> e <i>dye sublimation</i>)'),
  ...
  ('8443.31.14', 'A laser, LED (Diodos Emissores de Luz) ou LCS (Sistema de Cristal Líquido), monocromáticas, com largura de impressão superior a 280 mm, mas não superior a 420 mm'),
  ('8443.31.15', 'A laser, LED (Diodos Emissores de Luz) ou LCS (Sistema de Cristal Líquido), policromáticas'),
  ('8443.31.16', 'Outras, com largura de impressão superior a 420 mm'),
  ('8443.31.19', 'Outras'),
  ...
  ('8443.32.32', 'De transferência térmica de cera sólida (por exemplo, <i>solid ink</i> e <i>dye sublimation</i>)'),
  ...
  ('8443.32.34', 'A laser, LED (Diodos Emissores de Luz) ou LCS (Sistema de Cristal Líquido), monocromáticas, com largura de impressão superior a 280 mm, mas não superior a 420 mm'),
  ...
  ('8443.32.37', 'Térmicas, do tipo utilizado em impressão de imagens para diagnóstico médico em folhas revestidas com camada termossensível'),
  ...
  ('8443.32.52', 'Outros, com largura de impressão superior a 580 mm'),
  ('8443.32.59', 'Outros'),
  ('8443.32.91', 'Impressoras de código de barras postais, tipo 3 em 5, a jato de tinta fluorescente, com velocidade de até 4,5 m/s e passo de 1,4 mm'),
  ('8443.32.99', 'Outros'),
  ('8443.39.10', 'Máquinas de impressão por jato de tinta'),
  ('8443.39.21', 'De reprodução da imagem do original sobre a cópia por meio de um suporte intermediário (processo indireto), monocromáticas, para cópias de superfície inferior ou igual a 1 m<sup>2</sup>, com velocidade inferior a 100 cópias por minuto'),
  ('8443.39.28', 'Outras, por processo indireto'),
  ('8443.39.29', 'Outras'),
  ('8443.39.30', 'Outras máquinas copiadoras'),
  ('8443.39.90', 'Outros'),
  ('8443.91.10', 'De máquinas e aparelhos da subposição 8443.12'),
  ...
  ('8447.20.29', 'Outros'),
  ('8447.20.30', 'Máquinas de costura por entrelaçamento (<i>couture-tricotage</i>)'),
  ...
  ('8448.39.12', 'De máquinas do tipo <i>tow-to-yarn</i>'),
  ('8448.39.17', 'De outros filatórios'),
  ('8448.39.19', 'Outras'),
  ('8448.39.21', 'De bobinadoras de trama (espuladeiras)'),
  ('8448.39.22', 'De bobinadoras automáticas para fios elastanos, ou com atador automático'),
  ('8448.39.23', 'Outras, de bobinadoras automáticas'),
  ('8448.39.29', 'Outras'),
  ...
  ('8449.00.80', 'Outros'),
  ('8449.00.91', 'De máquinas ou aparelhos para fabricação de falsos tecidos (tecidos não tecidos)'),
  ('8449.00.99', 'Outras'),
  ...
  ('8450.20.90', 'Outras'),
  ('8450.90.10', 'De máquinas dos itens 8450.20.10 ou 8450.20.90'),
  ('8450.90.90', 'Outras'),
...
INSERT INTO public.ncm (codigo, descricao) VALUES
  ...
  ('8451.40.21', 'Para tingir tecidos em rolos; para tingir por pressão estática, com molinete (rotor de pás), jato de água (<i>jet</i>) ou combinada'),
  ('8451.40.29', 'Outras'),
  ('8451.40.90', 'Outras'),
  ...
  ('8467.11.90', 'Outras'),
  ('8467.19.00', '-- Outras'),
  ('8467.21.00', '-- Furadeiras (perfuradoras) de qualquer espécie, incluindo as rotativas'),
  ('8467.22.00', '-- Serras'),
  ('8467.29.10', 'Tesouras'),
  ...
  ('8471.70.40', 'De estado sólido (SSD - <i>Solid-State Drive</i>)'),
...
INSERT INTO public.ncm (codigo, descricao) VALUES
  ...
  ('8472.90.20', 'Máquinas do tipo utilizado em caixas de banco, com dispositivo para autenticar'),
  ('8472.90.30', 'Máquinas para selecionar e contar moedas ou notas (papéis-moeda)'),
  ('8472.90.40', 'Máquinas apontadoras de lápis (apara-lápis), perfuradores, grampeadores e desgrampeadores'),
  ...
  ('8473.29.90', 'Outros'),
  ('8473.30.11', 'Com fonte de alimentação, mesmo com módulo <i>display</i> numérico'),
  ('8473.30.19', 'Outros'),
  ('8473.30.31', 'Conjuntos cabeça-disco (HDA - <i>Head Disk Assembly</i>) de unidades de discos rígidos, montados'),
  ('8473.30.32', 'Braços posicionadores de cabeças magnéticas'),
  ('8473.30.33', 'Cabeças magnéticas'),
  ('8473.30.34', 'Mecanismos bobinadores para unidades de fitas magnéticas (<i>magnetic tape transporter</i>)'),
  ('8473.30.39', 'Outras'),
  ('8473.30.41', 'Placas-mãe (<i>mother boards</i>)'),
  ('8473.30.42', 'Placas (módulos) de memória com uma superfície inferior ou igual a 50 cm<sup>2</sup>'),
  ('8473.30.49', 'Outros'),
  ('8473.30.90', 'Outros'),
  ...
  ('8473.50.50', 'Placas (módulos) de memória com uma superfície inferior ou igual a 50 cm<sup>2</sup>'),
  ('8473.50.90', 'Outros'),
  ...
  ('8479.89.99', 'Outros'),
  ('8479.90.10', 'De limpadores de para-brisas elétricos ou de acumuladores hidráulicos para aeronaves'),
  ('8479.90.90', 'Outras'),
  ...
  ('8481.80.29', 'Outros'),
  ('8481.80.31', 'Com uma pressão de trabalho inferior ou igual a 50 mbar e dispositivo de segurança termoelétrico incorporado, do tipo utilizado em aparelhos domésticos'),
  ('8481.80.39', 'Outros'),
  ...
  ('8482.91.11', 'Para carga de canetas esferográficas'),
  ('8482.91.19', 'Outras'),
  ...
  ('8485.80.00', '- Outras'),
  ('8485.90.00', '- Partes'),
  ('8486.10.00', '- Máquinas e aparelhos para fabricação de <i>boules</i> ou <i>wa</i><i>fers</i>'),
  ...
  ('8504.31.19', 'Outros'),
  ('8504.31.91', 'Transformador de saída horizontal (<i>fly back</i>), com tensão de saída superior a 18 kV e frequência de varredura horizontal igual ou superior a 32 kHz'),
  ('8504.31.92', 'Transformadores de FI, de detecção, de relação, de linearidade ou de foco'),
  ('8504.31.93', 'Outros, de largura e comprimento não superior a 50 mm e altura não superior a 25 mm, próprios para montagem por inserção (PTH - <i>Pin Through Hole</i>) ou montagem em superfície (SMD - <i>Surface Mounted Device</i>)')
ON CONFLICT (codigo) DO NOTHING;
...
INSERT INTO public.ncm (codigo, descricao) VALUES
  ...
  ('8504.40.40', 'Equipamento de alimentação ininterrupta de energia (UPS ou <i>no break</i>)'),
  ...
  ('8504.40.90', 'Outros'),
  ('8504.50.10', 'De largura e comprimento não superior a 45 mm e altura não superior a 30 mm, próprias para montagem por inserção (PTH - <i>Pin Through Hole</i>) ou montagem em superfície (SMD - <i>Surface Mounted Device</i>)'),
  ('8504.50.90', 'Outras'),
  ...
  ('8505.19.90', 'Outros'),
  ('8505.20.10', 'Freios (travões) que atuam por corrente de Foucault, do tipo utilizado nos veículos das posições 87.01 a 87.05'),
  ('8505.20.90', 'Outros'),
  ...
  ('8506.10.39', 'Outras'),
  ('8506.30.10', 'Com volume exterior não superior a 300 cm<sup>3</sup>'),
  ('8506.30.90', 'Outras'),
  ('8506.40.10', 'Com volume exterior não superior a 300 cm<sup>3</sup>'),
  ('8506.40.90', 'Outras'),
  ('8506.50.10', 'Com volume exterior não superior a 300 cm<sup>3</sup>'),
  ('8506.50.90', 'Outras'),
  ('8506.60.10', 'Com volume exterior não superior a 300 cm<sup>3</sup>'),
  ('8506.60.90', 'Outras'),
  ('8506.80.10', 'Com volume exterior não superior a 300 cm<sup>3</sup>'),
  ('8506.80.90', 'Outras'),
  ('8506.90.00', '- Partes'),
  ...
  ('8515.29.00', '-- Outros'),
  ('8515.31.10', 'Robôs para soldar, por arco, em atmosfera inerte (MIG - <i>Metal Inert Gas</i>) ou atmosfera ativa (MAG - <i>Metal Active Gas</i>), de comando numérico'),
  ('8515.31.90', 'Outros'),
  ('8515.39.00', '-- Outros'),
  ...
  ('8517.62.29', 'Outros'),
  ('8517.62.34', 'Aparelhos para comutação de pacotes de dados (<i>switches</i>)'),
  ('8517.62.39', 'Outros'),
  ...
  ('8517.62.54', 'Distribuidores de conexões para redes (<i>hubs</i>)'),
  ...
  ('8517.62.94', 'Tradutores (conversores) de protocolos para interconexão de redes (<i>gateways</i>)'),
  ...
  ('8518.29.90', 'Outros'),
  ('8518.30.00', '- Fones de ouvido (Auscultadores e auriculares*), mesmo combinados com um microfone, e conjuntos ou sortidos constituídos por um microfone e um ou mais alto-falantes (altifalantes)'),
  ...
  ('8518.90.90', 'Outras'),
  ('8519.20.00', '- Aparelhos que funcionem por introdução de moedas, notas (papéis-moeda), cartões de banco, fichas ou por outros meios de pagamento'),
  ...
  ('8521.10.89', 'Outros'),
  ('8521.10.90', 'Outros, para fitas de largura igual ou superior a 19,05 mm (3/4'''')'),
  ('8521.90.00', '- Outros'),
  ('8522.10.00', '- Fonocaptores'),
  ('8522.90.00', '- Outros'),
  ('8523.21.10', 'Não gravados'),
  ('8523.21.20', 'Gravados'),
  ('8523.29.11', 'Do tipo utilizado em unidades de discos rígidos'),
  ('8523.29.19', 'Outros'),
  ('8523.29.90', 'Outros'),
  ...
  ('8523.49.90', 'Outros'),
  ('8523.51.10', 'Cartões de memória (<i>memory cards</i>)'),
  ('8523.51.90', 'Outros'),
  ...
  ('8524.12.00', '-- De diodos emissores de luz orgânicos (OLED)'),
  ('8524.19.00', '-- Outros'),
  ...
  ('8525.50.22', 'Em banda UHF, de frequência igual ou superior a 2,0 GHz, mas não superior a 2,7 GHz, com potência de saída igual ou superior a 10 W, mas não superior a 100 W')
ON CONFLICT (codigo) DO NOTHING;
...
INSERT INTO public.ncm (codigo, descricao) VALUES
  ...
  ('8525.60.90', 'Outros'),
  ('8525.81.00', '-- Ultrarrápidas, mencionadas na Nota de subposições 1 do presente Capítulo'),
  ('8525.82.00', '-- Outras, resistentes à radiação, mencionadas na Nota de subposições 2 do presente Capítulo'),
  ('8525.83.00', '-- Outras, de visão noturna, mencionadas na Nota de subposições 3 do presente Capítulo'),
  ('8525.89.11', 'Com três ou mais captadores de imagem'),
  ('8525.89.12', 'Com sensor de imagem a semicondutor tipo CCD, de mais de 490 x 580 elementos de imagem (<i>pixels</i>) ativos, sensíveis a intensidades de iluminação inferiores a 0,20 lux'),
  ('8525.89.13', 'Com sensor de imagem a semicondutor tipo CMOS, de mais de 490 x 580 elementos de imagem (<i>pixels</i>) ativos, sensíveis a intensidades de iluminação inferiores a 0,20 lux'),
  ('8525.89.14', 'Outras, próprias para captar imagens exclusivamente no espectro infravermelho de comprimento de onda igual ou superior a 2 micrômetros (mícrons), mas não superior a 14 micrômetros (mícrons)'),
  ('8525.89.19', 'Outras'),
  ('8525.89.21', 'Com três ou mais captadores de imagem'),
  ('8525.89.22', 'Outras, próprias para captar imagens exclusivamente no espectro infravermelho de comprimento de onda igual ou superior a 2 micrômetros (mícrons), mas não superior a 14 micrômetros (mícrons)'),
  ('8525.89.29', 'Outras'),
  ...
  ('8527.12.00', '-- Rádios toca-fitas (Rádios-leitores de cassetes*) de bolso'),
  ...
  ('8528.49.30', 'Policromáticos, com dispositivos de seleção de varredura (<i>underscanning</i>) e de retardo de sincronismo horizontal e vertical (<i>H/V delay</i> ou <i>pulse cross</i>)'),
  ('8528.49.90', 'Outros'),
  ...
  ('8528.69.90', 'Outros'),
  ('8528.71.11', 'Sem saída de radiofrequência (RF) modulada nos canais 3 ou 4, com saídas de áudio balanceadas com impedância de 600 Ohms, próprio para montagem em <i>racks</i> e com saída de vídeo com conector BNC'),
  ('8528.71.19', 'Outros'),
  ('8528.71.90', 'Outros'),
  ('8528.72.00', '-- Outros, a cores'),
  ('8528.73.00', '-- Outros, a preto e branco ou outros monocromos'),
  ('8529.10.20', 'Antenas com refletor parabólico'),
  ('8529.10.90', 'Outros'),
  ...
  ('8529.90.50', 'De módulos de visualização da posição 85.24'),
  ('8529.90.90', 'Outras'),
  ...
  ('8532.21.19', 'Outros'),
  ('8532.21.20', 'Próprios para montagem por inserção (PTH - <i>Pin Through Hole</i>)'),
  ('8532.21.90', 'Outros'),
  ('8532.22.00', '-- Eletrolíticos de alumínio'),
  ('8532.23.10', 'Próprios para montagem em superfície (SMD - <i>Surface Mounted Device</i>)'),
  ('8532.23.90', 'Outros'),
  ('8532.24.10', 'Próprios para montagem em superfície (SMD - <i>Surface Mounted Device</i>)'),
  ('8532.24.20', 'Próprios para montagem por inserção (PTH - <i>Pin Through Hole</i>)'),
  ('8532.24.90', 'Outros'),
  ('8532.25.10', 'Próprios para montagem em superfície (SMD - <i>Surface Mounted Device</i>)'),
  ('8532.25.90', 'Outros'),
  ('8532.29.10', 'Próprios para montagem em superfície (SMD - <i>Surface Mounted Device</i>)'),
  ('8532.29.90', 'Outros'),
  ('8532.30.10', 'Próprios para montagem em superfície (SMD - <i>Surface Mounted Device</i>)'),
  ('8532.30.90', 'Outros'),
  ('8532.90.00', '- Partes'),
  ('8533.10.00', '- Resistências fixas de carbono, aglomeradas ou de camada'),
  ('8533.21.10', 'De fio'),
  ('8533.21.20', 'Próprias para montagem em superfície (SMD - <i>Surface Mounted Device</i>)'),
  ('8533.21.90', 'Outras'),
  ('8533.29.00', '-- Outras'),
  ...
  ('8533.40.12', 'Varistores para uma tensão inferior ou igual a 1.000 V'),
  ('8533.40.13', 'Outros varistores'),
  ('8533.40.19', 'Outras'),
  ('8533.40.91', 'Potenciômetro de carvão, do tipo utilizado para determinar o ângulo de abertura da borboleta, em sistemas de injeção de combustível controlados eletronicamente'),
  ...
  ('8536.90.50', 'Terminais de conexão para condensadores, mesmo montados em suporte isolante'),
  ('8536.90.60', 'Conector de corrente elétrica para acoplamento através da carcaça, do tipo utilizado em motocompressores herméticos de refrigeração'),
  ('8536.90.90', 'Outros'),
  ...
  ('8537.10.90', 'Outros'),
  ('8537.20.10', 'Subestações isoladas a gás (GIS - <i>Gas-Insulated Switchgear</i> ou HIS - <i>Highly Integrated Switchgear</i>), para uma tensão superior a 52 kV'),
  ('8537.20.90', 'Outros'),
  ...
  ('8538.90.20', 'De disjuntores, para uma tensão igual ou superior a 72,5 kV'),
  ('8538.90.90', 'Outras'),
  ...
  ('8539.39.19', 'Outros'),
  ('8539.39.90', 'Outros'),
  ('8539.41.10', 'De potência igual ou superior a 1.000 W'),
  ('8539.41.90', 'Outras'),
  ('8539.49.00', '-- Outros'),
  ...
  ('8540.20.90', 'Outros'),
  ('8540.40.00', '- Tubos de visualização de dados gráficos, em monocromos; tubos de visualização de dados gráficos, a cores, com uma tela (ecrã*) fosfórica de espaçamento entre os pontos inferior a 0,4 mm'),
  ('8540.60.10', 'Tubos de visualização de dados gráficos, em cores, com uma tela de espaçamento entre os pontos igual ou superior a 0,4 mm'),
  ('8540.60.90', 'Outros'),
  ...
  ('8540.89.90', 'Outros'),
  ('8540.91.10', 'Bobinas de deflexão (<i>yokes</i>)'),
  ('8540.91.20', 'Núcleos de pó ferromagnético para bobinas de deflexão (<i>yokes</i>)'),
  ...
  ('8541.21.20', 'Montados, próprios para montagem em superfície (SMD - <i>Surface Mounted Device</i>)'),
  ...
  ('8541.41.21', 'Diodos emissores de luz (LED), exceto diodos laser, próprios para montagem em superfície (SMD - <i>Surface Mounted Device</i>)'),
  ('8541.41.22', 'Outros diodos emissores de luz (LED), exceto diodos laser'),
  ('8541.41.23', 'Diodos laser com comprimento de onda de 1.300 nm ou 1.500 nm'),
  ...
  ('8541.49.00', '-- Outros'),
  ('8541.51.00', '-- Transdutores à base de semicondutores'),
  ('8541.59.00', '-- Outros'),
  ('8541.60.10', 'De quartzo, de frequência igual ou superior a 1 MHz, mas não superior a 100 MHz'),
  ('8541.60.90', 'Outros'),
  ...
  ('8542.31.20', 'Montados, próprios para montagem em superfície (SMD - <i>Surface Mounted Device</i>)'),
  ('8542.31.90', 'Outros'),
...
INSERT INTO public.ncm (codigo, descricao) VALUES
  ...
  ('8542.32.99', 'Outras'),
  ('8542.33.11', 'De espessura de camada inferior ou igual a 1 micrômetro (mícron) com frequência de operação igual ou superior a 800 MHz'),
  ('8542.33.19', 'Outros'),
  ('8542.33.20', 'Outros, não montados'),
  ('8542.33.90', 'Outros'),
  ('8542.39.11', 'De espessura de camada inferior ou igual a 1 micrômetro (mícron) com frequência de operação igual ou superior a 800 MHz'),
  ('8542.39.19', 'Outros'),
  ...
  ('8543.70.11', 'Para transmissão de sinais de micro-ondas de alta potência (HPA), a válvula TWT do tipo <i>Phase Combiner</i>, com potência de saída superior a 2,7 kW'),
  ...
  ('8543.70.36', 'Roteador-comutador (<i>routing switcher</i>) de mais de 20 entradas e mais de 16 saídas, de áudio ou de vídeo'),
  ('8543.70.39', 'Outros'),
  ...
  ('8545.90.30', 'Suportes de conexão (<i>nipples</i>), para eletrodos'),
  ('8545.90.90', 'Outros'),
  ('8546.10.00', '- De vidro'),
  ...
  ('8547.20.90', 'Outras'),
  ('8547.90.00', '- Outros'),
  ('8548.00.10', 'Termopares do tipo utilizado em dispositivos termoelétricos de segurança de aparelhos alimentados a gás'),
  ('8548.00.90', 'Outras'),
  ('8549.11.00', '-- Desperdícios e resíduos, e sucata, de acumuladores de chumbo-ácido; acumuladores de chumbo-ácido inservíveis'),
  ('8549.12.00', '-- Outros, que contenham chumbo, cádmio ou mercúrio'),
  ('8549.13.00', '-- Selecionados por tipo de componente químico e que não contenham chumbo, cádmio ou mercúrio'),
  ('8549.14.00', '-- Não selecionados e que não contenham chumbo, cádmio ou mercúrio'),
  ('8549.19.00', '-- Outros'),
  ('8549.21.00', '-- Que contenham pilhas, baterias de pilhas ou acumuladores, elétricos, interruptores de mercúrio, vidro de tubos catódicos ou outros vidros ativados, ou componentes elétricos ou eletrônicos que contenham cádmio, mercúrio, chumbo ou policlorobifenilas (PCB)'),
  ('8549.29.00', '-- Outros'),
  ('8549.31.00', '-- Que contenham pilhas, baterias de pilhas ou acumuladores, elétricos, interruptores de mercúrio, vidro de tubos catódicos ou outros vidros ativados, ou componentes elétricos ou eletrônicos que contenham cádmio, mercúrio, chumbo ou policlorobifenilas (PCB)'),
  ('8549.39.00', '-- Outras'),
  ('8549.91.00', '-- Que contenham pilhas, baterias de pilhas ou acumuladores, elétricos, interruptores de mercúrio, vidro de tubos catódicos ou outros vidros ativados, ou componentes elétricos ou eletrônicos que contenham cádmio, mercúrio, chumbo ou policlorobifenilas (PCB)'),
  ('8549.99.00', '-- Outros'),
  ...
  ('8608.00.90', 'Outros'),
  ('8609.00.00', 'Contêineres (Contentores*), incluindo os de transporte de fluidos, especialmente concebidos e equipados para um ou mais meios de transporte.'),
  ...
  ('8702.20.00', '- Equipados para propulsão, simultaneamente, com motor de pistão de ignição por compressão (diesel ou semidiesel) e motor elétrico'),
  ('8702.30.00', '- Equipados para propulsão, simultaneamente, com motor de pistão de ignição por centelha (faísca) e motor elétrico'),
  ('8702.40.10', 'Trólebus'),
  ('8702.40.90', 'Outros'),
  ('8702.90.00', '- Outros'),
  ...
  ('8703.21.00', '-- De cilindrada não superior a 1.000 cm<sup>3</sup>'),
  ...
  ('8703.33.90', 'Outros'),
  ('8703.40.00', '- Outros veículos, equipados para propulsão, simultaneamente, com motor de pistão de ignição por centelha (faísca) e motor elétrico, exceto os suscetíveis de serem carregados por conexão a uma fonte externa de energia elétrica'),
  ('8703.50.00', '- Outros veículos, equipados para propulsão, simultaneamente, com motor de pistão de ignição por compressão (diesel ou semidiesel) e motor elétrico, exceto os suscetíveis de serem carregados por conexão a uma fonte externa de energia elétrica'),
  ('8703.60.00', '- Outros veículos, equipados para propulsão, simultaneamente, com motor de pistão de ignição por centelha (faísca) e motor elétrico, suscetíveis de serem carregados por conexão a uma fonte externa de energia elétrica'),
  ('8703.70.00', '- Outros veículos, equipados para propulsão, simultaneamente, com motor de pistão de ignição por compressão (diesel ou semidiesel) e motor elétrico, suscetíveis de serem carregados por conexão a uma fonte externa de energia elétrica'),
  ...
  ('8704.23.40', 'De chassis articulado, para o transporte de troncos (<i>forwarder</i>), com grua incorporada, de potência máxima igual ou superior a 126 kW (170 HP)'),
  ('8704.23.90', 'Outros'),
  ...
  ('8705.10.90', 'Outros'),
  ('8705.20.00', '- Torres (<i>derricks</i>) automóveis, para sondagem ou perfuração'),
  ...
  ('8708.40.90', 'Partes'),
  ('8708.50.11', 'Eixos com diferencial com capacidade de suportar cargas superiores ou iguais a 14.000 kg, redutores planetários nos extremos e dispositivo de freio (travão) incorporado, do tipo utilizado em veículos da subposição 8704.10'),
  ...
  ('8708.94.83', 'Caixas'),
  ('8708.94.90', 'Partes'),
  ('8708.95.10', 'Bolsas infláveis de segurança com sistema de insuflação (<i>airbags</i>)'),
  ('8708.95.21', 'Bolsas infláveis para <i>airbags</i>'),
  ...
  ('8711.10.00', '- Com motor de pistão de cilindrada não superior a 50 cm<sup>3</sup>'),
  ('8711.20.10', 'Motocicletas de cilindrada inferior ou igual a 125 cm<sup>3</sup>'),
  ('8711.20.20', 'Motocicletas de cilindrada superior a 125 cm<sup>3</sup>')
ON CONFLICT (codigo) DO NOTHING;

INSERT INTO public.ncm (codigo, descricao) VALUES
  ('8711.20.90', 'Outros'),
  ('8711.30.00', '- Com motor de pistão de cilindrada superior a 250 cm<sup>3</sup>, mas não superior a 500 cm<sup>3</sup>'),
  ('8711.40.00', '- Com motor de pistão de cilindrada superior a 500 cm<sup>3</sup>, mas não superior a 800 cm<sup>3</sup>'),
  ('8711.50.00', '- Com motor de pistão de cilindrada superior a 800 cm<sup>3</sup>'),
  ...
  ('8714.94.10', 'Cubos de freios (travões)'),
  ('8714.94.90', 'Outros'),
  ('8714.95.00', '-- Selins'),
  ...
  ('8716.10.00', '- Reboques e semirreboques, para habitação ou para acampar, do tipo <i>trailer</i> (caravana*)'),
  ...
  ('8802.12.10', 'De peso não superior a 3.500 kg'),
  ('8802.12.90', 'Outros'),
  ('8802.20.10', 'A hélice'),
  ...
  ('8802.20.90', 'Outros'),
  ('8802.30.10', 'A hélice'),
  ('8802.30.21', 'Multimotores, de peso não superior a 7.000 kg, vazios (sem carga)'),
  ('8802.30.29', 'Outros'),
  ('8802.30.31', 'De peso não superior a 7.000 kg, vazios (sem carga)'),
  ('8802.30.39', 'Outros'),
  ('8802.30.90', 'Outros'),
  ...
  ('8806.29.00', '-- Outros'),
  ('8806.91.00', '-- De peso máximo de decolagem não superior a 250 g'),
  ('8806.92.00', '-- De peso máximo de decolagem superior a 250 g, mas não superior a 7 kg'),
  ('8806.93.00', '-- De peso máximo de decolagem superior a 7 kg, mas não superior a 25 kg'),
  ('8806.94.00', '-- De peso máximo de decolagem superior a 25 kg, mas não superior a 150 kg'),
  ('8806.99.00', '-- Outros'),
  ...
  ('8807.90.00', '- Outras'),
  ('8901.10.00', '- Transatlânticos, barcos de excursão e embarcações semelhantes principalmente concebidas para o transporte de pessoas; <i>ferryboats</i>'),
  ...
  ('8902.00.90', 'Outros'),
  ('8903.11.00', '-- Equipados com um motor ou concebidos para comportá-lo, de peso vazio (sem carga) sem motor não superior a 100 kg'),
  ('8903.12.00', '-- Não concebidos para serem utilizados com um motor e de peso vazio (sem carga) não superior a 100 kg'),
  ('8903.19.00', '-- Outros'),
  ('8903.21.00', '-- De comprimento não superior a 7,5 m'),
  ('8903.22.00', '-- De comprimento superior a 7,5 m, mas não superior a 24 m'),
  ('8903.23.00', '-- De comprimento superior a 24 m'),
  ...
  ('8903.93.00', '-- De comprimento não superior a 7,5 m'),
  ('8903.99.00', '-- Outros'),
  ...
  ('9001.10.11', 'De diâmetro de núcleo inferior a 11 micrômetros (mícrons)'),
  ('9001.10.19', 'Outras'),
  ...
  ('9002.11.19', 'Outras'),
  ('9002.11.20', 'De aproximação (<i>zoom</i>) para câmeras de televisão, de 20 ou mais aumentos'),
  ('9002.11.90', 'Outras'),
  ('9002.19.00', '-- Outras'),
  ('9002.20.10', 'Polarizantes'),
  ('9002.20.90', 'Outros'),
  ('9002.90.10', 'Comutadores (<i>switches</i>) optomecânicos, do tipo utilizado em redes ópticas de transmissão de dados, próprios para montagem por inserção (PTH - <i>Pin Through Hole</i>)'),
  ('9002.90.90', 'Outros'),
  ...
  ('9006.59.51', 'Para obtenção de negativos de 45 mm x 60 mm ou de dimensões superiores'),
  ('9006.59.59', 'Outras'),
  ('9006.61.00', '-- Aparelhos de tubo de descarga para produção de luz relâmpago (<i>flash</i>) (denominados "<i>flashes</i> eletrônicos")'),
  ('9006.69.00', '-- Outros'),
  ('9006.91.10', 'Corpos'),
  ('9006.91.90', 'Outros'),
  ('9006.99.00', '-- Outros'),
  ('9007.10.00', '- Câmeras'),
  ('9007.20.20', 'Para filmes de largura igual ou superior a 35 mm, mas não superior a 70 mm'),
  ('9007.20.90', 'Outros'),
  ...
  ('9018.14.10', '<i>Scanner</i> de tomografia por emissão de posítrons (PET - <i>Positron Emission Tomography</i>)'),
  ...
  ('9018.20.90', 'Outros'),
  ('9018.31.11', 'De capacidade inferior ou igual a 2 cm<sup>3</sup>'),
  ('9018.31.19', 'Outras'),
  ('9018.31.90', 'Outras'),
...
INSERT INTO public.ncm (codigo, descricao) VALUES
  ...
  ('9018.90.96', 'Desfibriladores externos que operem unicamente em modo automático (AED - <i>Automatic External Defibrillator</i>)'),
  ('9018.90.97', 'Aparelhos destinados a procedimentos cirúrgicos assistidos por robótica'),
  ('9018.90.99', 'Outros'),
  ...
  ('9021.90.12', 'Implantes expansíveis (<i>stents</i>), mesmo montados sobre cateter do tipo balão'),
  ...
  ('9022.19.91', 'Do tipo utilizado para inspeção de bagagens, com túnel de altura inferior ou igual a 0,4 m, largura inferior ou igual a 0,6 m e comprimento inferior ou igual a 1,2 m'),
  ('9022.19.99', 'Outros'),
  ...
  ('9022.90.10', 'Geradores de tensão'),
  ('9022.90.20', 'Telas radiológicas'),
  ('9022.90.80', 'Outros, excluindo as partes e acessórios'),
  ...
  ('9031.20.90', 'Outros'),
  ('9031.41.00', '-- Para controle de <i>wafers</i> ou de dispositivos, semicondutores (incluindo os circuitos integrados), ou para controle de fotomáscaras ou retículos utilizados na fabricação de dispositivos semicondutores (incluindo os circuitos integrados)'),
...
INSERT INTO public.ncm (codigo, descricao) VALUES
  ...
  ('9303.90.90', 'Outros'),
  ('9304.00.10', 'Recipientes do tipo aerossol que contenham produtos químicos ou oleorresina de <i>Capsicum</i>, com fins irritantes'),
  ('9304.00.90', 'Outras'),
  ...
  ('9305.99.00', '-- Outros'),
  ('9306.21.10', 'Que contenham produtos químicos ou oleorresina de <i>Capsicum</i>, com fins irritantes'),
  ...
  ('9306.90.10', 'Granadas que contenham produtos químicos ou oleorresina de <i>Capsicum</i>, com fins irritantes'),
  ...
  ('9503.00.70', 'Quebra-cabeças (<i>puzzles</i>)'),
...
INSERT INTO public.ncm (codigo, descricao) VALUES
  ...
  ('9703.90.00', '- Outras'),
  ('9704.00.00', 'Selos postais, selos fiscais, marcas postais, envelopes de primeiro dia (<i>first-day covers</i>), inteiros postais e semelhantes, obliterados, ou não obliterados, exceto os artigos da posição 49.07.'),
